...
const vutils_1 = require("@visactor/vutils"), subBin = (data, options) => {
    var _a, _b, _c, _d;
    ...
    for (let i = 0; i < n; i++) {
        ...
        if (Number.isFinite(num)) for (let j = 0; j < numBins; j++) {
            ...
            if (num >= left && num < right || j === numBins - 1 && num <= right) {
                ...
                if (usingGroup) {
                    let gk;
                    gk = (0, vutils_1.isArray)(groupField) ? groupField.map((f => String(data[i][f]))).join("||") : String(data[i][groupField]);
                    ...
                    (0, vutils_1.isArray)(groupField) ? groupRepr.set(gk, Object.fromEntries(groupField.map((f => [ f, data[i][f] ])))) : groupRepr.set(gk, data[i][groupField])), 
    ...
    if (usingGroup) {
        for (let j = 0; j < numBins; j++) for (const gk of groupKeyOrder) {
            ...
            if ((0, vutils_1.isArray)(groupField)) for (const f of groupField) rec[f] = repr[f]; else groupField && (rec[groupField] = repr);
    ...
    if (0 === numBins) return [];
    const x0Name = null !== (_b = null === (_a = options.outputNames) || void 0 === _a ? void 0 : _a.x0) && void 0 !== _b ? _b : "x0", x1Name = null !== (_d = null === (_c = options.outputNames) || void 0 === _c ? void 0 : _c.x1) && void 0 !== _d ? _d : "x1", countName = null !== (_f = null === (_e = options.outputNames) || void 0 === _e ? void 0 : _e.count) && void 0 !== _f ? _f : "count", valuesName = null !== (_h = null === (_g = options.outputNames) || void 0 === _g ? void 0 : _g.values) && void 0 !== _h ? _h : "values", percentageName = null !== (_k = null === (_j = options.outputNames) || void 0 === _j ? void 0 : _j.percentage) && void 0 !== _k ? _k : "percentage", facetField = (0, 
    vutils_1.isArray)(null == options ? void 0 : options.facetField) ? null == options ? void 0 : options.facetField : (null == options ? void 0 : options.facetField) ? [ options.facetField ] : [], groupField = (0, 
    vutils_1.isArray)(null == options ? void 0 : options.groupField) ? null == options ? void 0 : options.groupField : (null == options ? void 0 : options.groupField) ? [ options.groupField ] : [], normalizedGroupField = groupField.length ? groupField : void 0, subViewOptions = Object.assign(Object.assign({}, options), {
        numBins: numBins,
...
exports.bin = bin, exports.default = exports.bin;
