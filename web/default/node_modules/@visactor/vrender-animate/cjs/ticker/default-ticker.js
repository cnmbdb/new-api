...
class DefaultTicker extends vutils_1.EventEmitter {
    ...
    init() {
        this.interval = 16, this.status = vrender_core_1.STATUS.INITIAL, vrender_core_1.application.global.hooks.onSetEnv.tap("graph-ticker", this._handleGraphTick), 
    ...
    release() {
        ...
        this.tickerHandler = null, this.lastFrameTime = -1, vrender_core_1.application.global.hooks.onSetEnv.unTap("graph-ticker", this._handleGraphTick);
    }
    checkSkip(delta) {
        var _a, _b, _c;
