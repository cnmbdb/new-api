...
export class EditModule {
    ...
    release() {
        ...
        this.textAreaDom.removeEventListener("focusin", this.handleFocusOut), this.textAreaDom.removeEventListener("focusout", this.handleFocusOut), 
        application.global.removeEventListener("keydown", this.handleKeyDown), null === (_a = this.textAreaDom.parentElement) || void 0 === _a || _a.removeChild(this.textAreaDom), 
