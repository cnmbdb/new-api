...
class Text extends graphic_1.Graphic {
    ...
    updateHorizontalMultilineAABBBounds(text) {
        ...
        const textMeasure = application_1.application.graphicUtil.getTextMeasureInstance(this.textMeasureId || (null === (_b = this.stage) || void 0 === _b ? void 0 : _b.textMeasureId)), layoutData = new layout_1.CanvasTextLayout(fontFamily, {
            fontSize: fontSize,
    ...
    updateWrapAABBBounds(text) {
        ...
        const textMeasure = application_1.application.graphicUtil.getTextMeasureInstance(this.textMeasureId || (null === (_b = this.stage) || void 0 === _b ? void 0 : _b.textMeasureId)), textOptions = {
            fontSize: fontSize,
            fontWeight: fontWeight,
            fontFamily: fontFamily,
            lineHeight: lineHeight
    ...
    updateVerticalMultilineAABBBounds(text) {
        var _a, _b, _c;
        const textTheme = this.getGraphicTheme(), textMeasure = application_1.application.graphicUtil.getTextMeasureInstance(this.textMeasureId || (null === (_a = this.stage) || void 0 === _a ? void 0 : _a.textMeasureId));
        let width;
