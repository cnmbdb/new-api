...
class WrapText extends text_1.Text {
    ...
    updateMultilineAABBBounds(text) {
        ...
        const textMeasure = application_1.application.graphicUtil.getTextMeasureInstance(this.textMeasureId || (null === (_c = this.stage) || void 0 === _c ? void 0 : _c.textMeasureId)), layoutObj = new layout_1.CanvasTextLayout(fontFamily, {
            fontSize: fontSize,
