...
/*!
   ...
   */let gi=class t extends Ve{constructor(e){super(S({},t.defaultOptions,e)),this.fillGridAt=(t,e)=>{t>=this.ngx||e>=this.ngy||t<0||e<0||(this.grid[t][e]=!1)},this.updateGrid=(t,e,i,n,s)=>{const o=s.occupied;let r=o.length;for(;r--;){const i=t+o[r][0],n=e+o[r][1];i>=this.ngx||n>=this.ngy||i<0||n<0||this.fillGridAt(i,n)}},this.gridSize=Math.max(Math.floor(this.options.gridSize),4)}getPointsAtRadius(t){if(this.pointsAtRadius[t])return this.pointsAtRadius[t];const e=8*t;let i=e;const n=[];for(0===t&&n.push([this.center[0],this.center[1],0]);i--;){const s=this.shape(i/e*2*Math.PI);n.push([this.center[0]+t*s*Math.cos(-i/e*2*Math.PI),this.center[1]+t*s*Math.sin(-i/e*2*Math.PI)*this.options.ellipticity,i/e*2*Math.PI])}return this.pointsAtRadius[t]=n,n}getTextInfo(t,e=1,i){var n;const s=this.options.clip?1:e,o=Math.max(Math.floor((this.isTryRepeatFill?this.options.fillTextFontSize:this.getTextFontSize(t))*s),this.options.minFontSize);let r=this.getText(t)+"";if(this.options.clip&&(r=r.slice(0,Math.ceil(r.length*e))),!r)return null;const a=this.getTextFontWeight(t),l=this.getTextFontStyle(t),h=this.getTextRotate&&null!==(n=this.getTextRotate(t,i))&&void 0!==n?n:0,c=this.getTextFontFamily(t),u=this.options.createCanvas({width:1,height:1}),d=u.getContext("2d",{willReadFrequently:!0});d.font=l+" "+a+" "+o.toString(10)+"px "+c;const g=d.measureText(r).width,f=Math.max(o,d.measureText("m").width,d.measureText("Ｗ").width);let p=g+2*f,x=3*f;const y=Math.ceil(p/this.gridSize),m=Math.ceil(x/this.gridSize);p=y*this.gridSize,x=m*this.gridSize;const v=-g/2,M=.4*-f,_=Math.ceil((p*Math.abs(Math.sin(h))+x*Math.abs(Math.cos(h)))/this.gridSize),b=Math.ceil((p*Math.abs(Math.cos(h))+x*Math.abs(Math.sin(h)))/this.gridSize),w=b*this.gridSize,S=_*this.gridSize;u.setAttribute("width",""+w),u.setAttribute("height",""+S),d.scale(1,1),d.translate(w/2,S/2),d.rotate(-h),d.font=l+" "+a+" "+o.toString(10)+"px "+c,d.fillStyle="#000",d.textBaseline="middle",d.fillText(r,v,M);const k=d.getImageData(0,0,w,S).data;if(this.exceedTime())return null;const z=[];let F,T=b;const R=[_/2,b/2,_/2,b/2],L=(t,e,i)=>{let n=this.gridSize;for(;n--;){let s=this.gridSize;for(;s--;)if(k[4*((e*this.gridSize+n)*w+(t*this.gridSize+s))+3])return i.push([t,e]),t<R[3]&&(R[3]=t),t>R[1]&&(R[1]=t),e<R[0]&&(R[0]=e),void(e>R[2]&&(R[2]=e))}};for(;T--;)for(F=_;F--;)L(T,F,z);return{datum:t,occupied:z,bounds:R,gw:b,gh:_,fillTextOffsetX:v,fillTextOffsetY:M,fillTextWidth:g,fillTextHeight:f,fontSize:o,fontStyle:l,fontWeight:a,fontFamily:c,angle:h,text:r}}calculateEmptyRate(){const t=this.ngx*this.ngy;let e=0;for(let t=0;t<this.ngx;t++)for(let i=0;i<this.ngy;i++)this.grid[t][i]&&e++;return e/t}canFitText(t,e,i,n,s){let o=s.length;for(;o--;){const i=t+s[o][0],n=e+s[o][1];if(i>=this.ngx||n>=this.ngy||i<0||n<0){if(!this.options.drawOutOfBound)return!1}else if(!this.grid[i][n])return!1}return!0}layoutWord(t,e=1){const i=this.data[t],n=this.getTextInfo(i,e,t);if(!n)return!1;if(this.exceedTime())return!1;if(!this.options.drawOutOfBound&&(!this.options.shrink||n.fontSize<=this.options.minFontSize)&&!this.options.clip){const t=n.bounds;if(t[1]-t[3]+1>this.ngx||t[2]-t[0]+1>this.ngy)return!1}let s=this.maxRadius+1;const o=t=>{const e=Math.floor(t[0]-n.gw/2),i=Math.floor(t[1]-n.gh/2),o=n.gw,r=n.gh;return!!this.canFitText(e,i,o,r,n.occupied)&&(n.distance=this.maxRadius-s,n.theta=t[2],this.outputText(e,i,n),this.updateGrid(e,i,o,r,n),!0)};for(;s--;){let t=this.getPointsAtRadius(this.maxRadius-s);this.options.random&&(t=[].concat(t),T(t));if(t.some(o))return!0}return(this.options.clip||!!(this.options.shrink&&n.fontSize>this.options.minFontSize))&&this.layoutWord(t,.75*e)}outputText(t,e,i){const n=this.getTextColor(i),s={text:i.text,datum:i.datum,color:n,fontStyle:i.fontStyle,fontWeight:i.fontWeight,fontFamily:i.fontFamily,angle:i.angle,width:i.fillTextWidth,height:i.fillTextHeight,x:(t+i.gw/2)*this.gridSize,y:(e+i.gh/2)*this.gridSize+i.fillTextOffsetY+.5*i.fontSize,fontSize:i.fontSize};this.result.push(s),this.progressiveResult&&this.progressiveResult.push(s)}initGrid(t){this.grid=[];const e=this.options.shape;if(r(e)){const i=ni(e,t.width,t.height,void 0,!1,this.options.createCanvas);let n=i.getContext("2d").getImageData(0,0,this.ngx*this.gridSize,this.ngy*this.gridSize);this.options.onUpdateMaskCanvas&&this.options.onUpdateMaskCanvas(i);let s=ii(e.backgroundColor,void 0,this.options.createCanvas);const o=(t,e)=>{let i=this.gridSize;for(;i--;){let o=this.gridSize;for(;o--;)if(!s(n,e*this.gridSize+i,t*this.gridSize+o))return void(this.grid[t][e]=!0)}this.grid[t][e]=!1};let r=this.ngx;for(;r--;){this.grid[r]=[];let t=this.ngy;for(;t--;)o(r,t),!1!==this.grid[r][t]&&(this.grid[r][t]=!0)}n=s=void 0}else{let t=this.ngx;for(;t--;){this.grid[t]=[];let e=this.ngy;for(;e--;)this.grid[t][e]=!0}}}canRepeat(){return this.calculateEmptyRate()>.001}layout(t,e){this.initProgressive(),this.drawnCount=0,this.isTryRepeatFill=!1,this.originalData=t,this.data=t,this.pointsAtRadius=[],this.ngx=Math.floor(e.width/this.gridSize),this.ngy=Math.floor(e.height/this.gridSize);const{center:i,maxRadius:n}=je(this.options.shape,[e.width,e.height]);return this.center=e.origin?[e.origin[0]/this.gridSize,e.origin[1]/this.gridSize]:[i[0]/this.gridSize,i[1]/this.gridSize],this.maxRadius=Math.floor(n/this.gridSize),this.initGrid(e),this.result=[],this.progressiveRun()}};gi.defaultOptions={gridSize:8,ellipticity:1,maxSingleWordTryCount:1};class fi extends Ve{constructor(t){super(S({},fi.defaultOptions,t)),this.random=this.options.random?Math.random:()=>0,this.aspectRatio=1}fit(t){for(let e=0,i=this.result.length;e<i;e++)if(pi(t,this.result[e]))return!1;return!0}getTextInfo(t,e){const i={datum:t,fontSize:this.getTextFontSize(t),fontWeight:this.getTextFontWeight(t),fontStyle:this.getTextFontStyle(t),fontFamily:this.getTextFontFamily(t),angle:this.getTextRotate(t,e),text:this.getText(t)+"",x:this.center[0],y:this.center[1]},n=this.options.getTextBounds(i);return i.width=n.width(),i.height=n.height(),i.top=this.center[1]-i.height+.21*i.height,i.left=this.center[0]-i.width/2,i}layoutWord(t){const e=this.getTextInfo(this.data[t],t);let i=2*Math.PI,n=0,s=e.left,o=e.top;const r=e.width,a=e.height;let l=1,h=this.fit(e);for(;!h&&n<this.maxRadius;)n+=.5,l=this.shape(n/this.maxRadius*2*Math.PI),i+=.5*(this.options.random?this.random()>.5?1:-1:t%2==0?1:-1),s=this.center[0]-r/2+n*l*Math.cos(i)*this.aspectRatio,o=this.center[1]-a/2+n*l*Math.sin(i),e.left=s,e.top=o,e.x=s+r/2,e.y=o+a/2,h=this.fit(e);return!!h&&(!!(this.options.clip||e.left>=0&&e.left+e.width<=this.width&&e.top>=0&&e.top+e.height<=this.height)&&(this.result.push(e),!0))}layout(t,e){if(!(null==t?void 0:t.length))return[];this.initProgressive(),this.result=[],this.maxRadius=Math.sqrt(e.width*e.width+e.height*e.height)/2,this.center=[e.width/2,e.height/2],this.width=e.width,this.height=e.height,this.data=t.sort(((t,e)=>this.getTextFontSize(e)-this.getTextFontSize(t)));let i=0;for(;i<t.length&&(this.layoutWord(i),i++,this.progressiveIndex=i,!this.exceedTime()););return this.result}}function pi(t,e){return!(t.left+t.width<e.left||t.top+t.height<e.top||t.left>e.left+e.width||t.top>e.top+e.height)}fi.defaultOptions={enlarge:!1};const xi={x:"x",y:"y",z:"z",fontFamily:"fontFamily",fontSize:"fontSize",fontStyle:"fontStyle",fontWeight:"fontWeight",angle:"angle"},yi=t=>h(t)||d(t)||n(t)||c(t)?t:e=>e[t.field],mi=t=>t<0?-Math.sqrt(-t):Math.sqrt(t),vi=(t,e,i)=>{if(t[0]===t[1])return t=>e[0];const n=mi(t[0]),s=mi(t[1]),o=Math.min(n,s),r=Math.max(n,s);return t=>(mi(t)-o)/(r-o)*(e[1]-e[0])+e[0]},Mi=(t,e)=>{let i=1/0,n=-1/0;const s=e.length;let o;for(let r=0;r<s;++r)o=C(t(e[r])),o<i&&(i=o),o>n&&(n=o);return 1===e.length&&i===n&&(i-=1e4),[i,n]};function _i(t,e,i,n,s){const o=Math.max(t[0],t[1])/2,r=function(t,e,i,n,s){const{x:o,y:r}=s,a=o/t*Math.PI*2;let l=Math.PI-r/e*Math.PI;l+=(l<Math.PI/2?1:-1)*Math.pow(Math.min(l-Math.PI/2,1),2)/5;const h=i*Math.sin(l)*Math.cos(a)+n.x,c=i*Math.cos(l)+n.y,u=i*Math.sin(l)*Math.sin(a)+n.z;return{x:h,y:c,z:u}}(t[0],t[1],o,{x:o,y:o,z:null!=s?s:o},e);i[n.x]=r.x,i[n.y]=r.y,i[n.z]=r.z}var bi;t.WORDCLOUD_SHAPE_HOOK_EVENT=void 0,(bi=t.WORDCLOUD_SHAPE_HOOK_EVENT||(t.WORDCLOUD_SHAPE_HOOK_EVENT={})).BEFORE_WORDCLOUD_SHAPE_LAYOUT="beforeWordcloudShapeLayout",bi.AFTER_WORDCLOUD_SHAPE_LAYOUT="afterWordcloudShapeLayout",bi.AFTER_WORDCLOUD_SHAPE_DRAW="afterWordcloudShapeDraw";class wi{constructor(t=1e3){this._map=new Map,this._maxSize=t}get(t){const e=this._map.get(t);if(void 0!==e)return this._map.delete(t),this._map.set(t,e),e}set(t,e){if(this._map.has(t))this._map.set(t,e);else{if(this._map.size>=this._maxSize){const t=this._map.keys().next().value;void 0!==t&&this._map.delete(t)}this._map.set(t,e)}}clear(){this._map.clear()}size(){return this._map.size}}const Si=t=>/^[\u4e00-\u9fa5]+$/.test(t),ki=(t,e)=>{if(s(t))return 0;let i=0;for(const e of t)Si(e)?i+=1:i+=.53;return i};function zi(t,e,i){const{stepFactor:n,importantWordCount:s,globalShinkLimit:o}=e,{size:r,segmentation:{regions:a},tempCanvas:l,boardSize:h,shapeCenter:c,shapeMaxR:u,shapeRatio:d}=i,g=l.getContext("2d",{willReadFrequently:!0}),f=Ii(i);let p=f.slice(0);const x=e.fontSizeShrinkFactor;let y=null,m=1,v=1;const M=s;let _=0;if(t.length>M){_=t.sort(((t,e)=>e.weight-t.weight))[M].weight}for(let i=0;i<a.length;i++){const s=a[i],{words:c,center:u,maxR:d,ratio:M}=s;let b=!1;for(let i=0;i<c.length;i++){Li(l,g,t,i,e.measureCache);const s=c[i];if(s.x=u[0],s.y=u[1],!s.skip&&s.hasText&&s.sprite&&Fi(p,s,d,M,r,h,n))s.hasPlaced=!0;else{if(!s.skip&&s.weight>_&&v>o){const e=s.datum[Symbol.for("vGrammar_id")];e!==y&&(y=e,m=v),v*=x,t.forEach((t=>{t.hasText=!1,t.sprite=null,t.fontSize=t.fontSize*x})),p=f.slice(0),b=!0;break}if(!s.skip&&s.datum[Symbol.for("vGrammar_id")]===y){t.forEach((t=>{t.hasText=!1,t.sprite=null,t.fontSize=t.fontSize/v})),s.skip=!0,v=m,y=null,p=f.slice(0),b=!0;break}}}b&&(i=-1)}for(let i=0;i<e.textLayoutTimes;i++){const i=t.filter((t=>(t.hasPlaced||(t.hasText=!1,t.sprite=null,t.fontSize=Math.max(~~(t.fontSize*e.fontSizeShrinkFactor),e.minFontSize)),!t.hasPlaced)));if(0===i.length)break;for(let t=0;t<i.length;t++){const s=i[t];Li(l,g,i,t,e.measureCache),s.x=c[0],s.y=c[1],s.hasText&&Fi(p,s,u,d,r,h,n)&&(s.hasPlaced=!0)}}e.board=p}function Fi(t,e,i,n,s,o,r){const a=e.x,l=e.y,h=function(t){return function(e){return[t*(e*=.1)*Math.cos(e),e*Math.sin(e)]}}(n),c=1*r;let u,d,g,f=-c;for(;u=h(f+=c);){const{wordSize:n,bounds:{dTop:r,dBottom:h,dLeft:c,dRight:f}}=e;if(d=u[0],g=u[1],Math.min(Math.abs(d),Math.abs(g))>=i)break;if(e.x=~~(a+d),e.y=~~(l+g),!(e.x-c<0||e.x+f>s[0]||e.y-r<0||e.y+h>s[1]||Ri(e,t,o)))return Ti(e,t,o),!0}return!1}function Ti(t,e,i){const{wordSize:n}=t,s=t.sprite,o=n[0]>>5,r=i[0]>>5,a=t.x-(o<<4),l=a%32,h=32-l,c=n[1];let u,d=(t.y-(n[1]>>1))*r+(a>>5);if(0===l)for(let t=0;t<c;t++){for(let i=0;i<o;i++)e[d+i]|=s[t*o+i];d+=r}else for(let t=0;t<c;t++){u=0;for(let i=0;i<=o;i++)e[d+i]|=u<<h|(i<o?(u=s[t*o+i])>>>l:0);d+=r}}function Ri(t,e,i){const{sprite:n,wordSize:s}=t,o=i[0]>>5,r=s[0]>>5,a=t.x-(r<<4),l=a%32,h=32-l,c=s[1];let u,d=(t.y-(s[1]>>1))*o+(a>>5);if(0===l)for(let t=0;t<c;t++){for(let i=0;i<r;i++)if(e[d+i]&n[t*r+i])return!0;d+=o}else for(let t=0;t<c;t++){u=0;for(let i=0;i<=r;i++)if((u<<h|(i<r?(u=n[t*r+i])>>>l:0))&e[d+i])return!0;d+=o}return!1}function Li(t,e,i,n,s){const o=i[n];if(o.sprite||0===o.fontSize)return;if(s){const t=s.get(Ci(o));if(t)return o.sprite=t.sprite,o.bounds=t.bounds,o.wordSize=t.wordSize,void(o.hasText=!0)}const r=2048,a=2048,l=Math.PI/180,h=i.length;t.width=r,t.height=a,e.clearRect(0,0,r,a),e.textAlign="center";let c,u,d=0,g=0,f=0,p=0;const x=n;for(--n;++n<h;){const t=i[n],s=Math.max(t.fontSize,2);if(e.save(),e.font=t.fontStyle+" "+t.fontWeight+" "+s+"px "+t.fontFamily,c=e.measureText(t.text+"m").width+2*t.padding,u=2*s+2*t.padding,0!==t.rotate){const e=Math.sin(t.rotate*l),i=Math.cos(t.rotate*l),n=c*i,s=c*e,o=u*i,r=u*e;c=Math.max(Math.abs(n+r),Math.abs(n-r)),u=~~Math.max(Math.abs(s+o),Math.abs(s-o))}if(c=c+31>>5<<5,u=Math.ceil(u),u>f&&(f=u),d+c>=r&&(d=0,g+=f,f=u),g+u>=a){if(0===g){t.hasText=!1;continue}break}g+u>=p&&(p=g+u),e.translate(d+(c>>1),g+(u>>1)),0!==t.rotate&&e.rotate(t.rotate*l),e.fillText(t.text,0,0),t.padding&&(e.lineWidth=2*t.padding,e.strokeText(t.text,0,0)),e.restore(),t.LT=[d,g],t.wordSize=[c,u],t.hasText=!0,d+=c}if(0===p)return;const y=e.getImageData(0,0,r,p).data;let m,v;for(;--n>=x;){const t=i[n];if(!t.hasText){t.bounds={dTop:1/0,dBottom:-1/0,dLeft:1/0,dRight:-1/0};break}const{LT:e=[0,0],wordSize:o}=t;[d,g]=e;const a=o[0]>>5,l=new Array(a*o[1]).fill(0);let[h,c,u,f]=[1/0,-1/0,1/0,-1/0];for(v=0;v<o[1];v++){let t;for(m=0;m<o[0];m++)if(y[4*((g+v)*r+(d+m))+3]>0){const e=1<<31-m%32;l[a*v+(m>>5)]|=e,m<u&&(u=m),m>f&&(f=m),t|=e}t&&(v<h&&(h=v),v>c&&(c=v))}if(t.bounds={dTop:(o[1]>>1)-h,dBottom:c-(o[1]>>1),dLeft:(o[0]>>1)-u,dRight:f-(o[0]>>1)},t.sprite=l,s){const e=Ci(t);s.set(e,{sprite:l,bounds:t.bounds,wordSize:o})}delete t.LT}}function Ci(t){return String(t.text)+"|"+String(t.fontFamily)+"|"+String(t.fontStyle)+"|"+String(t.fontWeight)+"|"+String(t.fontSize)+"|"+String(t.rotate)+"|"+String(t.padding)}function Ii(t){const{segmentation:{labels:e},boardSize:i,size:n}=t,s=i[0]>>5,o=new Array(s*n[1]).fill(0);for(let t=0;t<n[1];t++)for(let i=0;i<n[0];i++){if(0===e[t*n[0]+i]){const e=1<<31-i%32;o[s*t+(i>>5)]|=e}}if(i[0]>n[0]){const t=(1<<i[0]-n[0])-1;for(let e=0;e<n[1];e++){o[s*e+s-1]|=t}}return o}function Pi(t,e,i){!function(t,e){const{segmentation:{regions:i}}=e;let n=-1/0,s=0,o=0;i.forEach(((t,e)=>{const i=t.area;i>n&&(n=i,o=e),s+=i}));let r=0;i.forEach((e=>{const i=e.area,o=Math.ceil(i/s*t.length),a=i/n;e.words=[],e.regionNum=o,e.regionWeight=a,r+=o})),r<t.length&&(i[o].wordsNum+=t.length-r);let a=o;const l=i.map((t=>t.regionNum));t.forEach((t=>{let e=0,n=0;t.regionIndex=-1;do{if(l[a]>0&&t.weight<=i[a].regionWeight){t.regionIndex=a,i[a].words.push(t),l[a]--,a=(a+1)%i.length;break}a=(a+1)%i.length,e++,n++,n>i.length+1&&(i.forEach((t=>{t.regionWeight+=.15})),n=0)}while(-1===t.regionIndex&&e<3*i.length);-1===t.regionIndex&&(t.regionIndex=o,i[o].words.push(t),l[o]--)})),i.forEach((t=>{t.words.sort(((t,e)=>e.weight-t.weight))}))}(t,i),"ensureMapping"===e.layoutMode?zi(t,e,i):"ensureMappingEnlarge"===e.layoutMode?function(t,e,i){const{size:n,stepFactor:s,importantWordCount:o}=e,{segmentation:{regions:r},tempCanvas:a,boardSize:l,shapeCenter:h,shapeMaxR:c,shapeRatio:u}=i,d=a.getContext("2d",{willReadFrequently:!0}),g=Ii(i);let f=g.slice(0);const p=e.fontSizeEnlargeFactor,x=Math.min(o,t.length);let y=0;t.length>x&&(y=t.sort(((t,e)=>e.weight-t.weight))[x-1].weight);let m=0,v=1,M=!1;for(let o=0;o<r.length;o++){const h=r[o],{words:c,center:u,maxR:_,ratio:b}=h;let w=!1;for(let o=0;o<c.length;o++){Li(a,d,t,o,e.measureCache);const r=c[o];if(r.x=u[0],r.y=u[1],r.hasText&&r.sprite&&Fi(f,r,_,b,n,l,s)){if(r.hasPlaced=!0,r.weight>=y&&m++,m>=x&&!M){v*=p,t.forEach((t=>{t.hasText=!1,t.sprite=null,t.fontSize=t.fontSize*p})),f=g.slice(0),w=!0,m=0;break}}else{if(r.weight>=y&&v>1){t.forEach((t=>{t.hasText=!1,t.sprite=null,t.fontSize=t.fontSize/p})),v/=p,M=!0,f=g.slice(0),w=!0;break}if(r.weight>=y)return zi(t,e,i)}}w&&(o=-1)}for(let i=0;i<e.textLayoutTimes;i++){const i=t.filter((t=>(t.hasPlaced||(t.hasText=!1,t.sprite=null,t.fontSize=Math.max(~~(t.fontSize*e.fontSizeShrinkFactor),e.minFontSize)),!t.hasPlaced)));if(0===i.length)break;for(let t=0;t<i.length;t++){const o=i[t];Li(a,d,i,t,e.measureCache),o.x=h[0],o.y=h[1],o.hasText&&Fi(f,o,c,u,n,l,s)&&(o.hasPlaced=!0)}}e.board=f}(t,e,i):function(t,e,i){const{size:n,stepFactor:s}=e,{segmentation:{regions:o},tempCanvas:r,boardSize:a,shapeCenter:l,shapeMaxR:h,shapeRatio:c}=i,u=Ii(i),d=r.getContext("2d",{willReadFrequently:!0});for(const i of o){const{words:o,center:l,maxR:h,ratio:c}=i;for(let i=0;i<o.length;i++){Li(r,d,t,i,e.measureCache);const g=o[i];g.x=l[0],g.y=l[1],g.hasText&&g.sprite&&Fi(u,g,h,c,n,a,s)&&(g.hasPlaced=!0)}}for(let i=0;i<e.textLayoutTimes;i++){const i=t.filter((t=>(t.hasPlaced||(t.hasText=!1,t.sprite=null,t.fontSize=Math.max(~~(t.fontSize*e.fontSizeShrinkFactor),e.minFontSize)),!t.hasPlaced)));if(0===i.length)break;for(let t=0;t<i.length;t++){const o=i[t];Li(r,d,i,t,e.measureCache),o.x=l[0],o.y=l[1],o.hasText&&Fi(u,o,h,c,n,a,s)&&(o.hasPlaced=!0)}}e.board=u}(t,e,i);const n=function(t,e,i){const{size:n,fillingTimes:s,fillingXStep:o,fillingYStep:r,getFillingFontStyle:a,getFillingFontWeight:l,getFillingFontFamily:h,fillingInitialFontSize:c,fillingDeltaFontSize:u,fillingInitialOpacity:d,fillingDeltaOpacity:g,fillingRotateList:f,getFillingPadding:p,random:x,board:y,minFillFontSize:m}=e,{boardSize:v,shapeBounds:M,tempCanvas:_,randomGenerator:b}=i,w=_.getContext("2d",{willReadFrequently:!0});let S=c,k=d;const z=[];for(let t=0;t<s;t++)F(S,k),S=Math.max(S>u?S-u:u,m),k=k>g?k-g:g;return z;function F(i,s){const c=t.map((t=>{const{text:e,color:n,fillingColor:o,hasPlaced:r,datum:c}=t;return{x:0,y:0,weight:0,text:e,fontFamily:h(c),fontStyle:a(c),fontWeight:l(c),fontSize:i,rotate:f[~~(b()*f.length)],padding:p(c),opacity:s,visible:!0,color:n,fillingColor:o,hasPlaced:r,datum:c}}));T(c);let u=0;const{x1:d,y1:g,x2:m,y2:S}=M,[k,F]=[d+~~(b()*o*2),g+~~(b()*r*2)];for(let t=F;t<=S;t+=r)for(let i=k;i<=m;i+=o){Li(_,w,c,u,e.measureCache);const s=c[u];s.x=i,s.y=t;const{wordSize:o,bounds:r,hasPlaced:a}=s;if(!a||!r){++u===c.length&&(u=0,x&&T(c));continue}const{dTop:l,dBottom:h,dLeft:d,dRight:g}=r;s.x-d<0||s.x+g>n[0]||s.y-l<0||s.y+h>n[1]||s.hasText&&s.sprite&&!Ri(s,y,v)&&(Ti(s,y,v),z.push(Object.assign({},s)),++u===c.length&&(u=0,x&&T(c)))}}function T(t){return t.sort((()=>b()-.5))}}(t,e,i),s=[],o=[];for(let e=0;e<t.length;e++)t[e].hasPlaced?o.push(t[e]):s.push(t[e]);return s.forEach((t=>t.visible=!1)),{fillingWords:n,successedWords:o,failedWords:s}}function Oi(t,e){return t&&(f(t)||p(t)||t.startsWith("<svg"))?new Promise(((i,n)=>{var s;const o=e({image:t}),r=null===(s=o.resources)||void 0===s?void 0:s.get(t);r&&"success"===r.state&&r.data?i(r.data):(o.successCallback=()=>{var e;if(o){const s=null===(e=o.resources)||void 0===e?void 0:e.get(t);s&&"success"===s.state&&s.data?i(s.data):n(new Error("image load failed: "+t))}else n(new Error("image load failed: "+t))},o.failCallback=()=>{n(new Error("image load failed: "+t))})})):null}function Ei(t,e){return Promise.allSettled(t.map((t=>Oi(t,e))))}var Ai;function Di(t){return t}!function(t){t.Identity="identity",t.Linear="linear",t.Log="log",t.Pow="pow",t.Sqrt="sqrt",t.Symlog="symlog",t.Time="time",t.Quantile="quantile",t.Quantize="quantize",t.Threshold="threshold",t.Ordinal="ordinal",t.Point="point",t.Band="band"}(Ai||(Ai={})),Object.values(Ai).forEach((t=>{}));const Wi=t=>t<0?-Math.sqrt(-t):Math.sqrt(t),Bi=t=>t<0?-t*t:t*t;function Ni(t,e){if(t=Number(t),e=Number(e),e-=t)return i=>(i-t)/e;const i=Number.isNaN(e)?NaN:.5;return()=>i}function $i(t,e,i){const n=t[0],s=t[1],o=e[0],r=e[1];let a,l;return s<n?(a=Ni(s,n),l=i(r,o)):(a=Ni(n,s),l=i(o,r)),t=>l(a(t))}function qi(t,e,i){const n=Math.min(t.length,e.length)-1,o=new Array(n),r=new Array(n);let a=-1;for(t[n]<t[0]&&(t=t.slice().reverse(),e=e.slice().reverse());++a<n;)o[a]=Ni(t[a],t[a+1]),r[a]=i(e[a],e[a+1]);return function(e){const i=function(t,e,i=0,n){for(s(n)&&(n=t.length);i<n;){const s=i+n>>>1;L(t[s],e)>0?n=s:i=s+1}return i}(t,e,1,n)-1;return r[i](o[i](e))}}class ji{constructor(){this._rangeFactorStart=null,this._rangeFactorEnd=null}_calculateWholeRange(t){return this._wholeRange?this._wholeRange:o(this._rangeFactorStart)&&o(this._rangeFactorEnd)&&2===t.length?(this._wholeRange=function(t,e){const i=(t[1]-t[0])/(e[1]-e[0]),n=t[0]-i*e[0];return[n,i+n]}(t,[this._rangeFactorStart,this._rangeFactorEnd]),this._wholeRange):t}rangeFactor(t,e,i){return t?(2===t.length&&t.every((t=>t>=0&&t<=1))&&(this._wholeRange=null,0===t[0]&&1===t[1]?(this._rangeFactorStart=null,this._rangeFactorEnd=null):(this._rangeFactorStart=t[0],this._rangeFactorEnd=t[1])),this):i?(this._wholeRange=null,this._rangeFactorStart=null,this._rangeFactorEnd=null,this):o(this._rangeFactorStart)&&o(this._rangeFactorEnd)?[this._rangeFactorStart,this._rangeFactorEnd]:null}rangeFactorStart(t,e){var i;return s(t)?this._rangeFactorStart:(t>=0&&t<=1&&(this._wholeRange=null,0!==t||!s(this._rangeFactorEnd)&&1!==this._rangeFactorEnd?(this._rangeFactorStart=t,this._rangeFactorEnd=null!==(i=this._rangeFactorEnd)&&void 0!==i?i:1):(this._rangeFactorStart=null,this._rangeFactorEnd=null)),this)}rangeFactorEnd(t,e){var i;return s(t)?this._rangeFactorEnd:(t>=0&&t<=1&&(this._wholeRange=null,0!==t||!s(this._rangeFactorStart)&&0!==this._rangeFactorStart?(this._rangeFactorEnd=t,this._rangeFactorStart=null!==(i=this._rangeFactorStart)&&void 0!==i?i:0):(this._rangeFactorStart=null,this._rangeFactorEnd=null)),this)}generateFishEyeTransform(){var t;if(!this._fishEyeOptions)return void(this._fishEyeTransform=null);const{distortion:e=2,radiusRatio:i=.1,radius:n}=this._fishEyeOptions,o=this.range(),r=o[0],a=o[o.length-1],l=Math.min(r,a),h=Math.max(r,a),c=D(null!==(t=this._fishEyeOptions.focus)&&void 0!==t?t:0,l,h),u=s(n)?(h-l)*i:n;let d=Math.exp(e);d=d/(d-1)*u;const g=e/u;this._fishEyeTransform=t=>{const e=Math.abs(t-c);if(e>=u)return t;if(e<=1e-6)return c;const i=d*(1-Math.exp(-e*g))/e*.75+.25;return c+(t-c)*i}}unknown(t){return arguments.length?(this._unknown=t,this):this._unknown}get(t,e){var i;return null!==(i=null==this?void 0:this[t])&&void 0!==i?i:e}}const Hi=Symbol("implicit");class Gi extends ji{specified(t){var e;return t?(this._specified=Object.assign(null!==(e=this._specified)&&void 0!==e?e:{},t),this):Object.assign({},this._specified)}_getSpecifiedValue(t){if(this._specified)return this._specified[t]}constructor(){super(),this.type=Ai.Ordinal,this._index=new Map,this._domain=[],this._ordinalRange=[],this._unknown=Hi}clone(){const t=(new Gi).domain(this._domain).range(this._ordinalRange).unknown(this._unknown);return this._specified&&t.specified(this._specified),t}calculateVisibleDomain(t){return o(this._rangeFactorStart)&&o(this._rangeFactorEnd)&&2===t.length?[this.invert(t[0]),this.invert(t[1])]:this._domain}scale(t){const e=`${t}`,i=this._getSpecifiedValue(e);if(void 0!==i)return i;let n=this._index.get(e);if(!n){if(this._unknown!==Hi)return this._unknown;n=this._domain.push(t),this._index.set(e,n)}const s=this._ordinalRange[(n-1)%this._ordinalRange.length];return this._fishEyeTransform?this._fishEyeTransform(s):s}invert(t){let e=0;for(;e<this._ordinalRange.length&&this._ordinalRange[e]!==t;)e++;return this._domain[(e-1)%this._domain.length]}domain(t){if(!t)return this._domain.slice();this._domain=[],this._index=new Map;for(const e of t){const t=`${e}`;this._index.has(t)||this._index.set(t,this._domain.push(e))}return this}range(t){if(!t)return this._ordinalRange.slice();const e=Array.from(t);return this._ordinalRange=e,this}index(t){var e;return this._index&&null!==(e=this._index.get(`${t}`))&&void 0!==e?e:-1}}const{interpolateRgb:Ui}=yt;function Vi(t,e){const i=typeof e;let n;if(s(e)||"boolean"===i)return()=>e;if("number"===i)return B(t,e);if("string"===i){if(n=pt.parseColorString(e)){const e=Ui(pt.parseColorString(t),n);return t=>e(t).formatRgb()}return B(Number(t),Number(e))}return e instanceof xt?Ui(t,e):e instanceof pt?Ui(t.color,e.color):e instanceof Date?function(t,e){const i=t.valueOf(),n=e.valueOf(),s=new Date;return t=>(s.setTime(i*(1-t)+n*t),s)}(t,e):B(Number(t),Number(e))}class Ki extends ji{constructor(t=Di,e=Di){super(),this._unknown=void 0,this.transformer=t,this.untransformer=e,this._forceAlign=!0,this._domain=[0,1],this._range=[0,1],this._clamp=Di,this._piecewise=$i,this._interpolate=Vi}calculateVisibleDomain(t){var e;return o(this._rangeFactorStart)&&o(this._rangeFactorEnd)&&2===t.length?[this.invert(t[0]),this.invert(t[1])]:null!==(e=this._niceDomain)&&void 0!==e?e:this._domain}fishEye(t,e,i){return t||i?(this._fishEyeOptions=t,this._fishEyeTransform=null,this.rescale(e)):this._fishEyeOptions}scale(t){var e;if(t=Number(t),Number.isNaN(t)||this._domainValidator&&!this._domainValidator(t))return this._unknown;this._output||(this._output=this._piecewise((null!==(e=this._niceDomain)&&void 0!==e?e:this._domain).map(this.transformer),this._calculateWholeRange(this._range),this._interpolate));const i=this._output(this.transformer(this._clamp(t)));return this._fishEyeTransform?this._fishEyeTransform(i):i}invert(t){var e;return this._input||(this._input=this._piecewise(this._calculateWholeRange(this._range),(null!==(e=this._niceDomain)&&void 0!==e?e:this._domain).map(this.transformer),B)),this._clamp(this.untransformer(this._input(t)))}domain(t,e){var i;if(!t)return(null!==(i=this._niceDomain)&&void 0!==i?i:this._domain).slice();this._domainValidator=null,this._niceType=null,this._niceDomain=null;const n=Array.from(t,C);return this._domain=n,this.rescale(e)}range(t,e){if(!t)return this._range.slice();const i=Array.from(t);return this._range=i,this.rescale(e)}rangeRound(t,e){const i=Array.from(t);return this._range=i,this._interpolate=N,this.rescale(e)}rescale(t){var e;if(t)return this;const i=null!==(e=this._niceDomain)&&void 0!==e?e:this._domain,n=i.length,s=this._range.length;let o=Math.min(n,s);if(n&&n<s&&this._forceAlign){const t=s-n+1,e=i[n-1],r=n>=2?(e-i[n-2])/t:0;for(let s=1;s<=t;s++)i[n-2+s]=e-r*(t-s);o=s}return this._autoClamp&&(this._clamp=W(i[0],i[o-1])),this._piecewise=o>2?qi:$i,this._output=this._input=null,this._wholeRange=null,this.generateFishEyeTransform(),this}clamp(t,e,i){return arguments.length?(e?(this._autoClamp=!1,this._clamp=e):(this._autoClamp=!!t,this._clamp=t?void 0:Di),this.rescale(i)):this._clamp!==Di}interpolate(t,e){return arguments.length?(this._interpolate=t,this.rescale(e)):this._interpolate}ticks(t=10){return[]}tickData(t=10){const e=this.ticks(t);return(null!=e?e:[]).map(((t,e)=>({index:e,tick:t,value:(this.scale(t)-this._range[0])/(this._range[1]-this._range[0])})))}rangeFactor(t,e){return t?(super.rangeFactor(t),this._output=this._input=null,this):super.rangeFactor()}rangeFactorStart(t,e){return s(t)?super.rangeFactorStart():(super.rangeFactorStart(t),this._output=this._input=null,this)}rangeFactorEnd(t,e){return s(t)?super.rangeFactorEnd():(super.rangeFactorEnd(t),this._output=this._input=null,this)}forceAlignDomainRange(t){return arguments.length?(this._forceAlign=t,this):this._forceAlign}}const Yi=Math.sqrt(50),Xi=Math.sqrt(10),Zi=Math.sqrt(2),Qi=[1,2,5,10],Ji=(t,e,i)=>{let n=1,s=t;const o=Math.floor((e-1)/2),r=Math.abs(t);return t>=0&&t<=Number.MIN_VALUE?s=0:t<0&&t>=-Number.MIN_VALUE?s=-(e-1):!i&&r<1?n=sn(r).step:(i||r>1)&&(s=Math.floor(t)-o*n),n>0?(t>0?s=Math.max(s,0):t<0&&(s=Math.min(s,-(e-1)*n)),R(0,e).map((t=>s+t*n))):t>0?en(0,-(e-1)/n,n):en((e-1)/n,0,n)},tn=A(((t,e,i,n)=>{let s,o,r,a,l=-1;if(i=+i,(t=+t)==(e=+e))return[t];if(Math.abs(t-e)<=Number.MIN_VALUE&&i>0)return[t];if((s=e<t)&&(o=t,t=e,e=o),a=on(t,e,i).step,!isFinite(a))return[];if(a>0){let i=Math.round(t/a),n=Math.round(e/a);for(i*a<t&&++i,n*a>e&&--n,r=new Array(o=n-i+1);++l<o;)r[l]=(i+l)*a}else if(a<0&&(null==n?void 0:n.noDecimals)){a=1;const i=Math.ceil(t),n=Math.floor(e);if(!(i<=n))return[];for(r=new Array(o=n-i+1);++l<o;)r[l]=i+l}else{a=-a;let i=Math.round(t*a),n=Math.round(e*a);for(i/a<t&&++i,n/a>e&&--n,r=new Array(o=n-i+1);++l<o;)r[l]=(i+l)/a}return s&&r.reverse(),r})),en=(t,e,i)=>{let n,s,o=-1;if(i>0){let r=Math.floor(t/i),a=Math.ceil(e/i);for((r+1)*i<t&&++r,(a-1)*i>e&&--a,s=new Array(n=a-r+1);++o<n;)s[o]=(r+o)*i}else{i=-i;let r=Math.floor(t*i),a=Math.ceil(e*i);for((r+1)/i<t&&++r,(a-1)/i>e&&--a,s=new Array(n=a-r+1);++o<n;)s[o]=(r+o)/i}return s},nn=A(((t,e,i,n)=>{let s,o,r;if(i=+i,(t=+t)==(e=+e))return Ji(t,i,null==n?void 0:n.noDecimals);if(Math.abs(t-e)<=Number.MIN_VALUE&&i>0)return Ji(t,i,null==n?void 0:n.noDecimals);(s=e<t)&&(r=t,t=e,e=r);const a=on(t,e,i);let l=a.step;if(!isFinite(l))return[];if(l>0){let n=1;const{power:s,gap:r}=a,h=10===r?2*10**s:1*10**s;for(;n<=5&&(o=en(t,e,l),o.length>i+1)&&i>2;)l+=h,n+=1;i>2&&o.length<i-1&&(o=((t,e,i)=>{let n;const s=t[0],o=t[t.length-1],r=e-t.length;if(o<=0){const e=[];for(n=r;n>=1;n--)e.push(s-n*i);return e.concat(t)}if(s>=0){for(n=1;n<=r;n++)t.push(o+n*i);return t}let a=[];const l=[];for(n=1;n<=r;n++)n%2==0?a=[s-Math.floor(n/2)*i].concat(a):l.push(o+Math.ceil(n/2)*i);return a.concat(t).concat(l)})(o,i,l))}else(null==n?void 0:n.noDecimals)&&l<0&&(l=1),o=en(t,e,l);return s&&o.reverse(),o})),sn=t=>{const e=Math.floor(Math.log(t)/Math.LN10),i=t/10**e;let n=Qi[0];return i>=Yi?n=Qi[3]:i>=Xi?n=Qi[2]:i>=Zi&&(n=Qi[1]),e>=0?{step:n*10**e,gap:n,power:e}:{step:-(10**-e)/n,gap:n,power:e}};function on(t,e,i){const n=(e-t)/Math.max(0,i);return sn(n)}function rn(t,e,i){let n;if(i=+i,(t=+t)==(e=+e)&&i>0)return[t];if(i<=0||0===(n=function(t,e,i){return(e-t)/Math.max(1,i-1)}(t,e,i))||!isFinite(n))return[];const s=new Array(i);for(let e=0;e<i;e++)s[e]=t+e*n;return s}function an(t,e=10){let i,n,s=0,o=t.length-1,r=t[s],a=t[o],l=10;for(a<r&&(n=r,r=a,a=n,n=s,s=o,o=n);l-- >0;){if(n=on(r,a,e).step,n===i)return t[s]=r,t[o]=a,t;if(n>0)r=Math.floor(r/n)*n,a=Math.ceil(a/n)*n;else{if(!(n<0))break;r=Math.ceil(r*n)/n,a=Math.floor(a*n)/n}i=n}}class ln extends Ki{constructor(){super(...arguments),this.type=Ai.Linear}clone(){var t;const e=new ln;return e.domain(this._domain,!0).range(this._range,!0).unknown(this._unknown).clamp(this.clamp(),null,!0).interpolate(this._interpolate),this._niceType&&(e._niceType=this._niceType,e._domainValidator=this._domainValidator,e._niceDomain=null===(t=this._niceDomain)||void 0===t?void 0:t.slice()),e}tickFormat(){return()=>{}}d3Ticks(t=10,e){const i=this.calculateVisibleDomain(this._range);return tn(i[0],i[i.length-1],t,e)}ticks(t=10,e){var i;if(n(null==e?void 0:e.customTicks))return e.customTicks(this,t);if(o(this._rangeFactorStart)&&o(this._rangeFactorEnd)&&(this._rangeFactorStart>0||this._rangeFactorEnd<1)&&2===this._range.length||!this._niceType)return this.d3Ticks(t,e);const s=null!==(i=this._niceDomain)&&void 0!==i?i:this._domain,r=this._domain,a=s[0],l=s[s.length-1];let h=nn(r[0],r[r.length-1],t,e);if(!h.length)return h;if(this._domainValidator)h=h.filter(this._domainValidator);else if((h[0]!==a||h[h.length-1]!==l)&&this._niceType){const t=s.slice();if("all"===this._niceType?(t[0]=h[0],t[t.length-1]=h[h.length-1],this._niceDomain=t,this.rescale()):"min"===this._niceType&&h[0]!==a?(t[0]=h[0],this._niceDomain=t,this.rescale()):"max"===this._niceType&&h[h.length-1]!==l&&(t[t.length-1]=h[h.length-1],this._niceDomain=t,this.rescale()),"all"!==this._niceType){const e=Math.min(t[0],t[t.length-1]),i=Math.max(t[0],t[t.length-1]);h=h.filter((t=>t>=e&&t<=i))}}return h}forceTicks(t=10){const e=this.calculateVisibleDomain(this._range);return rn(e[0],e[e.length-1],t)}stepTicks(t){const e=this.calculateVisibleDomain(this._range);return function(t,e,i){let n,s,o=-1;if(i=+i,(s=(e=+e)<(t=+t))&&(n=t,t=e,e=n),!isFinite(i)||e-t<=i)return[t];const r=Math.floor((e-t)/i+1),a=new Array(r);for(;++o<r;)a[o]=t+o*i;return s&&a.reverse(),a}(e[0],e[e.length-1],t)}nice(t=10,e){var i,n;const s=this._domain;let o=[];if(e){const t=function(t,e){const i=d(e.forceMin),n=d(e.forceMax);let s=null;const o=[];let r=null;const a=i&&n?t=>t>=e.forceMin&&t<=e.forceMax:i?t=>t>=e.forceMin:n?t=>t<=e.forceMax:null;return i?o[0]=e.forceMin:d(e.min)&&e.min<=Math.min(t[0],t[t.length-1])&&(o[0]=e.min),n?o[1]=e.forceMax:d(e.max)&&e.max>=Math.max(t[0],t[t.length-1])&&(o[1]=e.max),d(o[0])&&d(o[1])?(r=t.slice(),r[0]=o[0],r[r.length-1]=o[1]):s=d(o[0])||d(o[1])?d(o[0])?"max":"min":"all",{niceType:s,niceDomain:r,niceMinMax:o,domainValidator:a}}(s,e);if(o=t.niceMinMax,this._domainValidator=t.domainValidator,this._niceType=t.niceType,t.niceDomain)return this._niceDomain=t.niceDomain,this.rescale(),this}else this._niceType="all";if(this._niceType){const e=an(s.slice(),t);"min"===this._niceType?e[e.length-1]=null!==(i=o[1])&&void 0!==i?i:e[e.length-1]:"max"===this._niceType&&(e[0]=null!==(n=o[0])&&void 0!==n?n:e[0]),this._niceDomain=e,this.rescale()}return this}niceMin(t=10){this._niceType="min";const e=this._domain[this._domain.length-1],i=an(this.domain(),t);return i&&(i[i.length-1]=e,this._niceDomain=i,this.rescale()),this}niceMax(t=10){this._niceType="max";const e=this._domain[0],i=an(this._domain.slice(),t);return i&&(i[0]=e,this._niceDomain=i,this.rescale()),this}}class hn extends ln{constructor(){super(Wi,Bi),this.type=Ai.Sqrt}clone(){return(new hn).domain(this._domain,!0).range(this._range,!0).unknown(this._unknown).clamp(this.clamp(),null,!0).interpolate(this._interpolate)}}const cn={x:"x",y:"y",fontFamily:"fontFamily",fontSize:"fontSize",fontStyle:"fontStyle",fontWeight:"fontWeight",angle:"angle",opacity:"opacity",visible:"visible",isFillingWord:"isFillingWord",color:"color"};const un=(t,e,i,n)=>{var s,o,r,a;const{colorMode:l,getColor:h,getFillingColor:c}=e,{sameColorList:u}=i;let d,g,f=e.colorList,p=i.fillingColorList;if("ordinal"===l){const e=t.map((t=>h(t)));if(d=t=>(new Gi).domain(e).range(f).scale(t),c&&((null===(s=n.colorField)||void 0===s?void 0:s.field)!==(null===(o=n.fillingColorField)||void 0===o?void 0:o.field)||!u)){const e=t.map((t=>c(t)));g=t=>(new Gi).domain(e).range(p).scale(t)}}else{1===f.length&&(f=[f[0],f[0]]);const e=(new ln).domain(fn(h,t)).range(f);if(d=t=>e.scale(t),c&&((null===(r=n.colorField)||void 0===r?void 0:r.field)!==(null===(a=n.fillingColorField)||void 0===a?void 0:a.field)||!u)){1===p.length&&(p=[p[0],p[0]]);const e=(new ln).domain(fn(c,t)).range(p);g=t=>e.scale(t)}}Object.assign(e,{colorScale:d,fillingColorScale:g})},dn=(t,e,i)=>{let{fontSizeRange:s}=e;const{getFontSize:o,getText:r}=e;let a;if(o){if(o&&s){const e=(new hn).domain(fn(o,t)).range(s);a=t=>e.scale(o(t))}else if(o&&n(o)&&!s){const e=.5,[n,l]=fn(o,t),h=t.map((t=>({text:r(t),value:o(t),weight:l===n?1:(o(t)-n)/(l-n)}))),c=gn(h,i,!0);s=[~~(e*c),~~c];const u=(new hn).domain(fn(o,t)).range(s);a=t=>u.scale(o(t))}}else{const e=t.map((t=>({text:r(t)}))),n=gn(e,i,!1);a="function"==typeof(l=n)?l:function(){return l}}var l;Object.assign(e,{getFontSize:o,fontSizeRange:s,fontSizeScale:a})},gn=(t,e,i)=>{const n=e.shapeArea,s=e.ratio,o=e.segmentation.regions,r=Math.ceil(Math.sqrt(n)/12),a=t.reduce(((t,e)=>{const n=ki(e.text);return n<r?t+n*(i?(.5+.5*e.weight)**2:1):t}),0);if(0===a)return 12;let l=20;if(1===o.length)l=Math.sqrt(s*(n/(1.7*a)));else{const t=[];for(let e=0;e<o.length;e++){const i=o[e].area,r=o[e].ratio,l=i/n;if(l<.1)continue;const h=l*(a*(r<1?2.7-r:1.7)),c=Math.sqrt(s*(i/h));t.push(c)}l=t.length?Math.min(...t):Math.sqrt(s*(n/(1.7*a)))}return l};const fn=(t,e)=>{let i=1/0,n=-1/0;const s=e.length;let o;for(let r=0;r<s;++r)o=C(t(e[r])),o<i&&(i=o),o>n&&(n=o);return 1===e.length&&i===n&&(i-=1e4),[i,n]};var pn;function xn(t,e){t.aspectRatio>1?(t.width=e,t.height=~~(e/t.aspectRatio)):(t.height=e,t.width=~~(e*t.aspectRatio))}!function(t){t.BEFORE_IMAGECLOUD_LAYOUT="beforeImagecloudLayout",t.AFTER_IMAGECLOUD_LAYOUT="afterImagecloudLayout",t.AFTER_IMAGECLOUD_DRAW="afterImagecloudDraw"}(pn||(pn={}));class yn{constructor(t){this.progressiveResult=[],this.imageCollageList=[],this.options=t}preProcess(){const{imageConfig:t={},weight:e}=this.options,{padding:i=0}=t;let n=this.imageCollageList;return n.forEach(((t,n)=>{!1===t.valid?(t.x=-10,t.y=-10,t.width=0,t.height=0,t.opacity=0):(t.padding=i,t.weight=K(e)(this.data[n]),t.datum=this.data[n])})),n=n.filter((t=>!1!==t.valid)).sort(((t,e)=>e.weight-t.weight)),n}onImageCollageInputReady(t){t.forEach(((t,e)=>{if("fulfilled"===t.status){const i=t.value,{width:n,height:s}=i;this.imageCollageList.push(Object.assign({},this.data[e],{aspectRatio:n/s}))}else this.imageCollageList.push(Object.assign({},this.data[e],{valid:!1}))}))}layout(t){this.data=t,this.loadSegmentationInput(),this.loadImageCollageInput()}loadSegmentationInput(){var t,e,i,n,s,o;const r=this.options,a=r.size,l={shapeUrl:null!==(t=r.mask)&&void 0!==t?t:{type:"geometric",shape:"rect"},size:a,ratio:r.ratio||.8,tempCanvas:void 0,boardSize:[0,0],random:!1,randomGenerator:void 0,blur:null===(e=r.maskConfig)||void 0===e?void 0:e.edgeBlur},c=this.options.createCanvas({width:a[0],height:a[1]}),u=c.getContext("2d",{willReadFrequently:!0});u.textAlign="center",u.textBaseline="middle",l.tempCanvas=c;const d=a[0]+31>>5<<5;if(l.boardSize=[d,a[1]],l.random?l.randomGenerator=Math.random:l.randomGenerator=H(),this.segmentationInput=l,h(l.shapeUrl)){l.isEmptyPixel=ii(void 0,{threshold:null!==(n=null===(i=r.maskConfig)||void 0===i?void 0:i.threshold)&&void 0!==n?n:200,invert:null===(s=r.maskConfig)||void 0===s?void 0:s.invert},this.options.createCanvas);const t=Oi(l.shapeUrl,this.options.createImage);t?(this.isMaskImageFinished=!1,this.isLayoutFinished=!1,t.then((t=>{var e,i;this.isMaskImageFinished=!0;const n=r.size,s=this.options.createCanvas({width:n[0],height:n[1],dpr:1});l.maskCanvas=s;const o=s.getContext("2d");(null===(e=r.maskConfig)||void 0===e?void 0:e.removeWhiteBorder)&&ui(t,s,l.isEmptyPixel);const a=di(t,n);let h;o.clearRect(0,0,n[0],n[1]),o.drawImage(t,a.x,a.y,a.width,a.height),this.segmentationOutput=ci(this.segmentationInput),"masked"===(null===(i=this.options.layoutConfig)||void 0===i?void 0:i.placement)&&(h=this.generateTransparentMaskCanvas(t,n)),this.segmentationOutput.transparentMaskCanvas=h,this.options.onUpdateMaskCanvas&&this.options.onUpdateMaskCanvas(s,h)})).catch((t=>{this.isMaskImageFinished=!0}))):(this.isMaskImageFinished=!0,this.isLayoutFinished=!0)}else if(l.shapeUrl&&("text"===l.shapeUrl.type||"geometric"===l.shapeUrl.type)){l.isEmptyPixel=ii(l.shapeUrl.backgroundColor,void 0,this.options.createCanvas),"text"!==l.shapeUrl.type&&"geometric"!==l.shapeUrl.type||l.shapeUrl.backgroundColor||(l.shapeUrl.backgroundColor="rgba(255,255,255,255)");const t=ni(l.shapeUrl,a[0],a[1],void 0,null===(o=r.maskConfig)||void 0===o?void 0:o.invert,this.options.createCanvas);l.maskCanvas=t,this.segmentationOutput=ci(this.segmentationInput),this.options.onUpdateMaskCanvas&&this.options.onUpdateMaskCanvas(t,t),this.isMaskImageFinished=!0}}loadImageCollageInput(){const t=Ei(this.data.map((t=>K(this.options.image)(t))),this.options.createImage);t?t.then((t=>{this.onImageCollageInputReady(t),this.isImagesFinished=!0})).catch((t=>{this.isImagesFinished=!0,this.isLayoutFinished=!0,E.getInstance().error("image load failed",t)})):(this.isImagesFinished=!0,this.isLayoutFinished=!0)}canAnimate(){return!0}unfinished(){return!this.isLayoutFinished}output(){return this.progressiveResult}progressiveRun(){if(this.isImagesFinished&&this.isMaskImageFinished&&!this.isLayoutFinished){const t=this.preProcess(),e=this.doLayout(t);this.options&&this.options.onLayoutEnd&&this.options.onLayoutEnd(e),this.progressiveResult=this.processOutput(e),this.isLayoutFinished=!0}}progressiveOutput(){return this.progressiveResult}release(){this.segmentationInput=null,this.data=null,this.progressiveResult=null,this.options=null}calculateImageSize(t,e={},i=.45){const{imageSizeRange:s,padding:o=0}=e,r=d(e.imageSize)?e.imageSize:V(e.imageSize),a=this.options.size;if(r||s)if(r&&!n(r))t.forEach((t=>xn(t,r)));else if(s){const e=(new hn).domain(Z(t,(t=>t.weight))).range(s);t.forEach((t=>xn(t,~~e.scale(t.weight))))}else if(r&&n(r)&&!s){const e=.5,[n,s]=Z(t,(t=>t.weight)),r=t.reduce(((t,i)=>{const o=i.aspectRatio,r=(i.weight-n)/(s-n);return t+(o>1?1/o:o)*(e+(1-e)*r)**2}),0),l=~~Math.sqrt(i*a[0]*a[1]/r),h=[~~(e*l)-2*o<0?1:~~(e*l)-2*o,~~l-2*o<0?1:~~l-2*o],c=(new hn).domain(Z(t,(t=>t.weight))).range(h);t.forEach((t=>xn(t,~~c.scale(t.weight))))}else console.warn("image cloud imageSize error");else{const e=t.reduce(((t,e)=>{const i=e.aspectRatio;return t+(i>1?1/i:i)}),0);let n=~~Math.sqrt(i*a[0]*a[1]/e);n=n-2*o<0?1:n-2*o,t.forEach((t=>xn(t,n)))}return t}generateTransparentMaskCanvas(t,e){var i;const n=this.options.createCanvas({width:e[0],height:e[1],dpr:1}),s=n.getContext("2d");this.segmentationOutput.transparentMaskCanvas=n,(null===(i=this.options.maskConfig)||void 0===i?void 0:i.removeWhiteBorder)&&ui(t,n,this.segmentationInput.isEmptyPixel);const o=s.createImageData(e[0],e[1]),r=this.segmentationOutput.segmentation.labels;for(let t=0;t<r.length;t++){const e=0===r[t]?255:0,i=255*r[t],n=4*t;o.data[n]=e,o.data[n+1]=e,o.data[n+2]=e,o.data[n+3]=i}return s.clearRect(0,0,e[0],e[1]),s.fillStyle="rgba(255,255,255,0)",s.fillRect(0,0,e[0],e[1]),s.putImageData(o,0,0),n}processOutput(t){var e;const i=null===(e=this.options)||void 0===e?void 0:e.as;return i&&Object.keys(i).forEach((e=>{t.forEach((t=>{t[i[e]]=t[e],delete t[e]}))})),t}}class mn extends yn{preProcess(){const t=super.preProcess(),{imageConfig:e={},ratio:i=.45}=this.options;return this.calculateImageSize(t,e,i)}tryPlaceImage(t,e,i,n,s,o=1){const[r,a]=e,l=r/2,h=a/2,c=Math.sqrt(l**2+h**2),u=Ke[i](e);let d,g,f=-o;const{segmentation:p}=n,{labels:x}=p;for(;([d,g]=u(f+=o))&&!(Math.min(Math.abs(d),Math.abs(g))>=c);)if(d-=t.width/2,g-=t.height/2,t.visible=!0,t.x=~~(l+d),t.y=~~(h+g),t._left=t.x+t.padding,t._top=t.y+t.padding,t._leftWithoutPadding=t.x,t._topWithoutPadding=t.y,vn(t,s)){const{x:e,y:i,width:n,height:s}=t;let o=!1;for(let t=0;t<n;t++){for(let n=0;n<s&&i+t<=a;n++){if(e+n>r)continue;if(!!!x[(i+t)*r+(e+n)]){o=!0;break}}if(o)break}if(!o){const e=[{x:t.x,y:t.y},{x:t.x+t.width,y:t.y},{x:t.x,y:t.y+t.height},{x:t.x+t.width,y:t.y+t.height}];let i=!0;for(const t of e)if(!x[t.y*r+t.x]){i=!1;break}if(!i)continue;return!0}}return!1}doLayout(t){var e;const{segmentationOutput:i}=this,{layoutConfig:n={}}=this.options,s=this.options.size,{spiralType:o="archimedean",fillingTimes:r=4,minFillingImageSize:a=10}=n,l=[],h=Object.keys(t[0]).find((t=>t.includes("VGRAMMAR")));for(const e of t)e._widthWithPadding=e.width+2*e.padding,e._heightWithPadding=e.height+2*e.padding,e.frequency=1,this.tryPlaceImage(e,s,o,i,l)&&l.push(e);const c=F(l,((t,e)=>t.width-e.width)).width,u=F(l,((t,e)=>t.height-e.height)).height,d=[];for(let n=0;n<r;n++){const r=.5*c-1*n,g=.5*u-1*n;for(const n of t){const t=Object.assign({},n,{visible:!0});xn(t,Math.max(a,t.aspectRatio>1?r:g)),t._widthWithPadding=t.width+2*t.padding,t._heightWithPadding=t.height+2*t.padding,this.tryPlaceImage(t,s,o,i,[...d,...l],.5)&&(n._tempFrequency=(null!==(e=n._tempFrequency)&&void 0!==e?e:n.frequency)+1,t.frequency=n._tempFrequency,t.distance=Math.sqrt(Math.pow(t.x-s[0]/2,2)+Math.pow(t.y-s[1]/2,2)),t[h]=`${t[h]}_${t.frequency}`,d.push(t))}}return[...l,...d].filter((t=>t.visible))}}function vn(t,e){for(let i=0;i<e.length;i++)if(Mn(t,e[i]))return!1;return!0}function Mn(t,e){return!(t._leftWithoutPadding+t._widthWithPadding<e._leftWithoutPadding||t._topWithoutPadding+t._heightWithPadding<e._topWithoutPadding||t._leftWithoutPadding>e._leftWithoutPadding+e._widthWithPadding||t._topWithoutPadding>e._topWithoutPadding+e._heightWithPadding)}function _n(t){const{imageConfig:e={},size:i,ratio:n=.1,layoutConfig:s={}}=t,{padding:o=0,imageSize:r}=e,[a,l]=i;let h;h=r||Math.min(a,l)*n-2*o,h<0&&(h=1);const{rectAspectRatio:c=1}=s;let u,d;c>1?(u=h,d=h/c):(d=h,u=h*c);const g=Math.ceil(l/(d+o)),f=Math.ceil(a/(u+o)),p=a/2,x=l/2,y=new Array(f*g);for(let t=0;t<g;t++)for(let e=0;e<f;e++){const i=e*(u+o)+u/2,n=t*(d+o)+d/2;y[t*f+e]={centerX:i,centerY:n,x:i-u/2,y:n-d/2,row:t,col:e,distance:Math.sqrt(Math.pow(i-p,2)+Math.pow(n-x,2))}}const m=Object.assign({},s,{cellWidth:u,cellHeight:d,cellInfo:y,cellCount:y.length,cellType:"rect",cellPixelCount:u*d,eachPixel:(t,e)=>{const{x:i,y:n}=t;for(let t=0;t<u;t++)for(let s=0;s<d&&n+t<=l;s++)i+s>a||e((~~n+t)*a+(~~i+s))},clipPath:`M${-u/2} ${-d/2} L${u/2} ${-d/2} L${u/2} ${d/2} L${-u/2} ${d/2} Z`});return{context:m,imageLength:h}}const bn={rect:_n,circle:function(t){const{imageConfig:e={},size:i,ratio:n=.1,layoutConfig:s={}}=t,{padding:o=0,imageSize:r=0}=e,[a,l]=i,h=a/2,c=l/2;let u=0;u=r?r/2:Math.min(a,l)*n/2,u-o<=0&&(u=o+1);const d=2*u,g=Math.sqrt(3)/2*d+o,f=[];let p=0;for(let t=0;t*g-u<l;t++){const e=t*g,i=t%2==0?0:u;for(let n=-1;n*(d+o)+i-u<a;n++){const s=n*(d+o)+i+u;f[p++]={centerX:s,centerY:e,x:s-u,y:e-u,row:t,col:n,distance:Math.sqrt(Math.pow(s-h,2)+Math.pow(e-c,2))}}}let x=0;const y=u*u;for(let t=0;t<d;t++)for(let e=0;e<d;e++){const i=t-u,n=e-u;i*i+n*n<=y&&x++}const m=Object.assign({},s,{cellWidth:d,cellHeight:d,cellInfo:f,cellCount:f.length,cellType:"circle",cellPixelCount:x,eachPixel:(t,e)=>{const{x:i,y:n}=t;for(let t=0;t<d;t++)for(let s=0;s<d;s++){if(t+i<0||t+i>a||s+n>l||s+n<0)continue;const o=t-u,r=s-u;o*o+r*r<=y&&e((~~n+t)*a+(~~i+s))}},clipPath:"M 1 0 A 1 1 0 1 0 -1 0 A 1 1 0 1 0 1 0 Z"});return{context:m,imageLength:d}},hexagonal:function(t){const{imageConfig:e={},size:i,ratio:n=.1,layoutConfig:s={}}=t,{padding:o=0,imageSize:r}=e,[a,l]=i,h=a/2,c=l/2;let u;u=r?r/2:Math.min(a,l)*n/2,u-o<=0&&(u=o+1);const d=[],g=2*Math.PI/6;for(let t=0;t<6;t++){const e=g*t;d.push({x:(u-o/2)*Math.cos(e),y:(u-o/2)*Math.sin(e)})}const f=2*u,p=Math.sin(Math.PI/6)*f,x=Math.sqrt(3)*p,y=f-p/2,m=Math.cos(Math.PI/6)*f,v=m/2,M=Math.floor(l/x),_=Math.floor(a/p),b=[];for(let t=-1;t<=M+1;t++)for(let e=-1;e<=_;e++){const i=e*y,n=t*m+(e%2?v:0);b.push({centerX:i,centerY:n,x:i-p,y:n-p,row:t,col:e,distance:Math.sqrt(Math.pow(i-h,2)+Math.pow(n-c,2))})}let w=0;const S=[];for(let t=0;t<=x;t++)for(let e=0;e<=2*p;e++){const i=e-p,n=t-x/2,s=Math.abs(i),o=Math.abs(n);s<=p&&o<=x/2&&2*o+s*Math.sqrt(3)<=x?(w++,S.push(!0)):S.push(!1)}const k=Object.assign({},s,{cellHexSideLength:p,cellHexPoints:d,cellHeight:x,cellWidth:2*p,cellInfo:b,cellCount:b.length,cellType:"hexagonal",cellPixelCount:w,eachPixel:(t,e)=>{const{x:i,y:n}=t;let s=0;for(let t=0;t<=x;t++)for(let o=0;o<=2*p;o++)S[s++]&&e((~~n+t)*a+(~~i+o))},clipPath:"M 1 0 L 0.5 0.866 L -0.5 0.866 L -1 0 L -0.5 -0.866 L 0.5 -0.866 Z"});return{context:k,imageLength:f-o}}};class wn extends yn{preProcess(){var t;const e=super.preProcess(),{layoutConfig:i={}}=this.options,{cellType:n="rect"}=i,s=(null!==(t=bn[n])&&void 0!==t?t:bn.rect)(this.options),{context:o,imageLength:r}=s;return e.forEach((t=>function(t,e){t.aspectRatio>1?(t.height=e,t.width=~~(e*t.aspectRatio)):(t.width=e,t.height=~~(e/t.aspectRatio))}(t,r))),o.cellInfo.sort(((t,e)=>t.distance-e.distance)),this.layoutContext=o,e}doLayout(t){const{cellWidth:e,cellHeight:i,cellInfo:n,cellCount:s,clipPath:o,eachPixel:r,cellPixelCount:a}=this.layoutContext;if(0===t.length||0===s||0===e||0===i||0===n.length)return void(this.isLayoutFinished=!0);const{segmentationOutput:l}=this,{layoutConfig:h={}}=this.options,{placement:c="default"}=h;if("edge"===c||"default"===c){const{segmentation:t}=l,{labels:e}=t;n.forEach((t=>{let i=0;r(t,(t=>{e[t]&&i++})),t.intersectPixels=i}))}const u=t.length,d=t=>{const{intersectPixels:e}=t;return"default"===c?e>=.45*a:"edge"!==c||e>.1*a&&e<a};for(let e=0;e<u;e++){const i=t[e],s=n[e];s&&(i.x=s.centerX-i.width/2,i.y=s.centerY-i.height/2,i.clipConfig={shape:o},i.frequency=1,i.visible=d(s),i.cell=k(s,["image"]),i.distance=s.distance,s.image=i)}const g=Object.keys(t[0]).find((t=>t.includes("VGRAMMAR")));if(u<s)for(let e=u;e<s;e++){const i=t[e-u],s=n[e];if(s){const e=Object.assign({},i);e.x=s.centerX-e.width/2,e.y=s.centerY-e.height/2,e.frequency+=1,e[g]=`${e[g]}_${e.frequency}`,e.visible=d(s),e.distance=s.distance,e.cell=k(s,["image"]),s.image=e,t.push(e)}}return t.filter((t=>t.visible))}}class Sn extends yn{preProcess(){const t=super.preProcess(),{imageConfig:e={},ratio:i=.1}=this.options,n=_n;return this.layoutContext=n(Object.assign({},this.options,{imageConfig:{imageSize:null}})).context,this.layoutContext.cellInfo.sort(((t,e)=>t.distance-e.distance)),this.calculateImageSize(t,e,i)}doLayout(t){const{segmentationOutput:e}=this,{cellWidth:i,cellHeight:n,cellInfo:s,cellCount:o,eachPixel:r,cellPixelCount:a}=this.layoutContext;if(0===t.length||0===o||0===i||0===n||0===s.length)return void(this.isLayoutFinished=!0);const{layoutConfig:l={}}=this.options,h=this.options.size,{placement:c="default",maxAngle:u=Math.PI/180*45}=l;if("edge"===c||"default"===c){const{segmentation:t}=e,{labels:i}=t;s.forEach((t=>{let e=0;r(t,(t=>{i[t]&&e++})),t.intersectPixels=e}))}const d=t.length,g=Math.sqrt(Math.pow(h[0],2)+Math.pow(h[1],2)),f=t=>{const{intersectPixels:e}=t;return"default"===c?e>.5*a:"edge"!==c||e>.1*a&&e<a};for(let e=0;e<d;e++){const i=t[e],n=s[e];n&&(i.x=n.centerX-i.width/2,i.y=n.centerY-i.height/2,i.visible=f(n),i.cell=`${n.row}_${n.col}`,i.angle=Math.random()*(2*u)-u,i.anchor=[i.x+i.width/2,i.y+i.height/2],i.zIndex=g-n.distance,i.distance=n.distance,i.frequency=1,n.image=i)}const p=Object.keys(t[0]).find((t=>t.includes("VGRAMMAR")));if(d<o)for(let e=d;e<o;e++){const i=t[e-d],n=s[e];if(n){const e=Object.assign({},i);e.x=n.centerX-e.width/2,e.y=n.centerY-e.height/2,e.anchor=[e.x+e.width/2,e.y+e.height/2],e.angle=Math.random()*(2*u)-u,e.frequency+=1,e[p]=`${e[p]}_${e.frequency}`,e.visible=f(n),e.cell=`${n.row}_${n.col}`,e.distance=n.distance,e.zIndex=g-n.distance,n.image=e,t.push(e)}}return t.filter((t=>t.visible))}}t.CirclePackingLayout=Zt,t.ImageCloudGridLayout=wn,t.ImageCloudSpiralLayout=mn,t.ImageCloudStackLayout=Sn,t.SankeyLayout=re,t.SunburstLayout=ue,t.TreeLayout=be,t.TreemapLayout=ze,t.WordcloudCloudLayout=Xe,t.WordcloudFastLayout=fi,t.WordcloudGridLayout=gi,t.calculateNodeValue=It,t.circlePackingTransform=(t,e)=>{const i=new Zt(t).layout(e,"width"in t?{width:t.width,height:t.height}:{x0:t.x0,x1:t.x1,y0:t.y0,y1:t.y1});if(t.flatten){const e=[];return Et(i,e,{maxDepth:null==t?void 0:t.maxDepth}),e}return i},t.drawCardioid=li,t.drawRegularPolygon=ai,t.eachAfter=Ot,t.eachBefore=Pt,t.flattenNodes=Et,t.flattenTreeLinks=de,t.formatLinkPath=(t,e=!0)=>{var i;return!s(null===(i=null==t?void 0:t[0])||void 0===i?void 0:i.vertical)?t.map((t=>{const i=t.thickness/2;let n=t.y0,s=t.y1,o=(n+s)/2,r=t.x0-i,a=t.x0+i,l=t.x1-i,h=t.x1+i;return e&&(n=Math.round(n),s=Math.round(s),o=Math.round(o),r=Math.round(r),a=Math.round(a),l=Math.round(l),h=Math.round(h)),Object.assign({},t,{path:`\n            M${r},${n}\n            C${r},${o},${l},${o},${l},${s}\n            L${h},${s}\n            C${h},${o},${a},${o},${a},${n}\n            Z\n            `})})):t.map((t=>{const i=t.thickness/2;let n=t.x0,s=t.x1,o=(n+s)/2,r=t.y0-i,a=t.y0+i,l=t.y1-i,h=t.y1+i;return e&&(n=Math.round(n),s=Math.round(s),o=Math.round(o),r=Math.round(r),a=Math.round(a),l=Math.round(l),h=Math.round(h)),Object.assign({},t,{path:`\n          M${n},${r}\n          C${o},${r},${o},${l},${s},${l}\n          L${s},${h}\n          C${o},${h},${o},${a},${n},${a}\n          Z`})}))},t.formatLinkPolygon=t=>{var e;return!s(null===(e=null==t?void 0:t[0])||void 0===e?void 0:e.vertical)?t.map((t=>{const e=t.thickness/2,i=[{x:t.x0-e,y:t.y0},{x:t.x1-e,y:t.y1},{x:t.x1+e,y:t.y1},{x:t.x0+e,y:t.y0}];return Object.assign({},t,{points:i})})):t.map((t=>{const e=t.thickness/2,i=[{x:t.x0,y:t.y0-e},{x:t.x1,y:t.y1-e},{x:t.x1,y:t.y1+e},{x:t.x0,y:t.y0+e}];return Object.assign({},t,{points:i})}))},t.formatNodeRect=t=>t.map((t=>Object.assign({},t,{x:t.x0,y:t.y0,width:t.x1-t.x0,height:t.y1-t.y0}))),t.generateCardioidPoints=ri,t.generateIsEmptyPixel=ii,t.generateMaskCanvas=ni,t.generatePoints=oi,t.getAlignEndTexts=(t,e=0)=>ae(t[0])?t.map((t=>({y:t.y1-e,x:(t.x0+t.x1)/2,datum:t.datum,key:t.key}))):t.map((t=>({x:t.x0-e,y:(t.y0+t.y1)/2,datum:t.datum,key:t.key}))),t.getAlignStartTexts=(t,e=0)=>ae(t[0])?t.map((t=>({y:t.y1,x:(t.x0+t.x1)/2,datum:t.datum,key:t.key}))):t.map((t=>({x:t.x1,y:(t.y0+t.y1)/2,datum:t.datum,key:t.key}))),t.getArcsFromCircles=De,t.getArcsFromPath=t=>{const e=[],i=t.split("A"),n=i[0];let s=n.indexOf(",");for(e.push({p1:{x:+n.slice(1,s),y:+n.slice(s+1)}}),s=1;s<i.length;s++){const t=i[s].split(",");e[s-1].radius=+t[0];const n=+t[2].slice(2),o=+t[3].split(" ")[0];e[s-1].p2={x:n,y:o},e[s-1].largeArcFlag="1"===t[1][t[1].length-1],s<i.length-1&&e.push({p1:{x:n,y:o}})}return e},t.getBoundsOfNodes=t=>{let e=1/0,i=-1/0,n=1/0,s=-1/0;return t.forEach((t=>{e=Math.min(t.x0,e),i=Math.max(t.x1,i),n=Math.min(t.y0,n),s=Math.max(t.y1,s)})),{x0:e,x1:i,y0:n,y1:s,width:i-e,height:s-n}},t.getCirclesFromArcs=t=>{var e;return null!==(e=null==t?void 0:t.map((t=>{const{p1:e,p2:i,radius:n,largeArcFlag:s,setId:o}=t,{x:r,y:a}=e,{x:l,y:h}=i,c=((l-r)**2+(h-a)**2)**.5,u=(r+l)/2,d=(a+h)/2,g=(n**2-(c/2)**2)**.5;let f=u+g*(h-a)/c,p=d-g*(l-r)/c;var x,y;return((x=[l-r,h-a])[0]*(y=[f-r,p-a])[1]-x[1]*y[0]>0||s)&&(f=u-g*(h-a)/c,p=d+g*(l-r)/c),{x:f,y:p,radius:n,setId:o}})))&&void 0!==e?e:[]},t.getMaxRadiusAndCenter=je,t.getPathFromArcs=We,t.getShapeFunction=He,t.imagecloudTransform=(t,e,i)=>{var o,r;const a=n(t.size)?t.size():t.size;if(t.size=a,!a||s(a[0])||s(a[1])||a[0]<=0||a[1]<=0){return E.getInstance().info("Wordcloud size dimensions must be greater than 0"),[]}if(t.size=[Math.ceil(a[0]),Math.ceil(a[1])],t.image||E.getInstance().error("Imagecloud: image source must be specified."),t.onBeforeLayout&&t.onBeforeLayout(),!e||0===e.length)return[];let l;switch(null!==(r=null===(o=t.layoutConfig)||void 0===o?void 0:o.layoutMode)&&void 0!==r?r:"spiral"){case"grid":l=wn;break;case"stack":l=Sn;break;default:l=mn}const h=new l(t);return h.layout(e),h.unfinished()?{progressive:h}:h.output()},t.loadImage=Oi,t.loadImages=Ei,t.removeBorder=ui,t.sankeyTransform=le,t.scaleAndMiddleShape=di,t.segmentation=ci,t.shapes=$e,t.spirals=Ke,t.sunburstTransform=(t,e)=>{const i=new ue(t).layout(e,"width"in t?{width:t.width,height:t.height}:{x0:t.x0,x1:t.x1,y0:t.y0,y1:t.y1});if(t.flatten){const e=[];return Et(i,e,{maxDepth:null==t?void 0:t.maxDepth}),e}return i},t.treeTransform=(t,e)=>{const i=new be(t).layout(e,"width"in t?{width:t.width,height:t.height}:{x0:t.x0,x1:t.x1,y0:t.y0,y1:t.y1});if(t.flatten){const{maxDepth:e}=null!=t?t:{},n=[];Et(i,n,{maxDepth:e});const s=[];return de(i,s,{maxDepth:e}),{nodes:n,links:s}}return i},t.treemapTransform=(t,e)=>{const i=new ze(t).layout(e,"width"in t?{width:t.width,height:t.height}:{x0:t.x0,x1:t.x1,y0:t.y0,y1:t.y1});if(t.flatten){const e=[];return Et(i,e,{maxDepth:null==t?void 0:t.maxDepth}),e}return i},t.vennMarkTransform=Ne,t.vennTransform=Be,t.wordcloudShapeTransform=(t,e,i)=>{if(!t.size||s(t.size[0])||s(t.size[1])||t.size[0]<=0||t.size[1]<=0){return E.getInstance().info("Wordcloud size dimensions must be greater than 0"),[]}if(t.size=[Math.ceil(t.size[0]),Math.ceil(t.size[1])],t.shape||E.getInstance().error("WordcloudShape shape must be specified."),t.text||E.getInstance().error("WordcloudShape text must be specified."),t.onBeforeLayout&&t.onBeforeLayout(),!e||0===e.length)return[];const n=new class{constructor(t){this.progressiveResult=[],this.options=t}layout(t){this.data=t;const e=this.options,i={shapeUrl:e.shape,size:e.size,ratio:e.ratio||.8,tempCanvas:void 0,boardSize:[0,0],random:!1,randomGenerator:void 0},n=this.options.createCanvas({width:e.size[0],height:e.size[1]}),s=n.getContext("2d",{willReadFrequently:!0});s.textAlign="center",s.textBaseline="middle",i.tempCanvas=n;const o=e.size[0]+31>>5<<5;if(i.boardSize=[o,e.size[1]],i.random?i.randomGenerator=Math.random:i.randomGenerator=H(),this.segmentationInput=i,h(i.shapeUrl)){i.isEmptyPixel=ii(void 0,void 0,this.options.createCanvas);const t=Oi(i.shapeUrl,this.options.createImage);t?(this.isImageFinished=!1,this.isLayoutFinished=!1,t.then((t=>{this.isImageFinished=!0;const n=this.options.createCanvas({width:e.size[0],height:e.size[1],dpr:1});i.maskCanvas=n;const s=n.getContext("2d");e.removeWhiteBorder&&ui(t,n,i.isEmptyPixel);const o=di(t,e.size);s.clearRect(0,0,e.size[0],e.size[1]),s.drawImage(t,o.x,o.y,o.width,o.height),this.options.onUpdateMaskCanvas&&this.options.onUpdateMaskCanvas(i.maskCanvas)})).catch((t=>{this.isImageFinished=!0}))):(this.isImageFinished=!0,this.isLayoutFinished=!0)}else if(i.shapeUrl&&("text"===i.shapeUrl.type||"geometric"===i.shapeUrl.type)){i.isEmptyPixel=ii(i.shapeUrl.backgroundColor,void 0,this.options.createCanvas);const t=ni(i.shapeUrl,e.size[0],e.size[1],void 0,!1,this.options.createCanvas);i.maskCanvas=t,this.options.onUpdateMaskCanvas&&this.options.onUpdateMaskCanvas(t),this.doLayout(),this.isImageFinished=!0,this.isLayoutFinished=!0}}canAnimate(){return!0}unfinished(){return!this.isLayoutFinished}output(){return this.progressiveResult}progressiveRun(){this.isImageFinished&&!this.isLayoutFinished&&(this.segmentationInput.maskCanvas&&this.doLayout(),this.isLayoutFinished=!0)}progressiveOutput(){return this.progressiveResult}doLayout(){var t,e,i,n,s,o,r,a,l,h,c,u,d,g,f,p,x,y,m,v,M,_;const b=this.segmentationInput,w=ci(b);if(!w.segmentation.regions.length)return;const S=this.options,k=this.data,z=S.colorMode||"ordinal",F={getText:K(S.text),getFontSize:K(S.fontSize),fontSizeRange:S.fontSizeRange,colorMode:z,getColor:S.colorField?K(S.colorField):K(S.text),getFillingColor:K(S.fillingColorField),colorList:S.colorList||("ordinal"===z?["#2E62F1"]:["#537EF5","#2E62F1","#2358D8","#184FBF","#0C45A6","#013B8E"]),getColorHex:K(S.colorHexField),getFontFamily:K(S.fontFamily||"sans-serif"),rotateList:S.rotateList||[0],getPadding:K(S.padding||1),getFontStyle:K(S.fontStyle||"normal"),getFontWeight:K(S.fontWeight||"normal"),getFontOpacity:S.fontOpacity?K(S.fontOpacity):()=>1};dn(k,F,w);const T={size:S.size,ratio:S.ratio||.8,measureCache:null!==(t=S.measureCache)&&void 0!==t?t:new wi,shapeUrl:S.shape,random:void 0===S.random||S.random,textLayoutTimes:null!==(e=S.textLayoutTimes)&&void 0!==e?e:3,removeWhiteBorder:S.removeWhiteBorder,layoutMode:null!==(i=S.layoutMode)&&void 0!==i?i:"default",fontSizeShrinkFactor:null!==(n=S.fontSizeShrinkFactor)&&void 0!==n?n:.8,stepFactor:null!==(s=S.stepFactor)&&void 0!==s?s:1,importantWordCount:null!==(o=S.importantWordCount)&&void 0!==o?o:10,globalShinkLimit:S.globalShinkLimit||.2,fontSizeEnlargeFactor:null!==(r=S.fontSizeEnlargeFactor)&&void 0!==r?r:1.5,fillingRatio:null!==(a=S.fillingRatio)&&void 0!==a?a:.7,fillingTimes:null!==(l=S.fillingTimes)&&void 0!==l?l:4,fillingXStep:S.fillingXRatioStep?Math.max(Math.floor(S.size[0]*S.fillingXRatioStep),1):null!==(h=S.fillingXStep)&&void 0!==h?h:4,fillingYStep:S.fillingYRatioStep?Math.max(Math.floor(S.size[1]*S.fillingYRatioStep),1):null!==(c=S.fillingYStep)&&void 0!==c?c:4,fillingInitialFontSize:S.fillingInitialFontSize,fillingDeltaFontSize:S.fillingDeltaFontSize,fillingInitialOpacity:null!==(u=S.fillingInitialOpacity)&&void 0!==u?u:.8,fillingDeltaOpacity:null!==(d=S.fillingDeltaOpacity)&&void 0!==d?d:.05,getFillingFontFamily:K(S.fillingFontFamily||"sans-serif"),getFillingFontStyle:K(S.fillingFontStyle||"normal"),getFillingFontWeight:K(S.fillingFontWeight||"normal"),getFillingPadding:K(null!==(g=S.fillingPadding)&&void 0!==g?g:.4),fillingRotateList:null!==(f=S.fillingRotateList)&&void 0!==f?f:[0,90],fillingDeltaFontSizeFactor:null!==(p=S.fillingDeltaFontSizeFactor)&&void 0!==p?p:.2,fillingColorList:S.fillingColorList||["#537EF5"],sameColorList:!1,minInitFontSize:null!==(x=S.minInitFontSize)&&void 0!==x?x:10,minFontSize:null!==(y=S.minFontSize)&&void 0!==y?y:4,minFillFontSize:null!==(m=S.minFillFontSize)&&void 0!==m?m:2},R=((t,e)=>{if(1===e.length&&"#537EF5"===e[0])return!0;if(!Array.isArray(t)||!Array.isArray(e)||t.length!==e.length)return!1;for(let i=0;i<t.length;i++)if(t[i]!==e[i])return!1;return!0})(F.colorList,T.fillingColorList);T.sameColorList=R,un(k,F,T,S),function(t,e,i,n){const{getText:s}=e;let{fillingInitialFontSize:o,fillingDeltaFontSize:r}=i;const{fillingRatio:a}=i,l=Math.ceil(Math.sqrt(n.shapeArea)/4);if(!o||!r){const e=a/100,h=t.reduce(((t,e)=>{const i=ki(s(e));return i>l?t:t+i}),0)/t.length;let c;if(0===h)c=8;else{const t=.2*n.shapeArea;c=Math.sqrt(e*(t/h))}o=~~c,r=c*i.fillingDeltaFontSizeFactor,Object.assign(i,{fillingInitialFontSize:o,fillingDeltaFontSize:r})}}(k,F,T,w);const{getText:L,getFontFamily:C,getFontStyle:I,getFontWeight:P,getPadding:O,getColor:E,getFillingColor:A,getColorHex:D,fontSizeScale:W,colorScale:B,fillingColorScale:N,getFontOpacity:$,rotateList:q}=F,j=k.map((t=>{var e,i;return{x:0,y:0,weight:0,text:L(t),fontFamily:C(t),fontWeight:P(t),fontStyle:I(t),rotate:q[~~(b.randomGenerator()*q.length)],fontSize:Math.max(T.minInitFontSize,~~W(t)),opacity:$(t),padding:O(t),color:D&&D(t)||B&&B(E(t))||"black",fillingColor:!A||(null===(e=S.colorField)||void 0===e?void 0:e.field)===(null===(i=S.fillingColorField)||void 0===i?void 0:i.field)&&R?void 0:D&&D(t)||N&&N(A(t))||"black",datum:t,visible:!0,hasPlaced:!1}})),H=((t,e)=>{var i;if(0===t.length)return;let n=t[0];for(let s=1;s<t.length;s++){const o=t[s];(null!==(i=null==e?void 0:e(o,n))&&void 0!==i?i:o-n)>0&&(n=o)}return n})(j.map((t=>t.fontSize)));j.forEach((t=>t.weight=t.fontSize/H)),j.sort(((t,e)=>e.weight-t.weight));const{fillingWords:G,successedWords:U,failedWords:V}=Pi(j,T,w),Y=null!==(M=null===(v=S.text)||void 0===v?void 0:v.field)&&void 0!==M?M:"textKey",X=null!==(_=S.dataIndexKey)&&void 0!==_?_:"defaultDataIndexKey",Z=S.as?Object.assign(Object.assign({},cn),S.as):cn;let Q,J;const tt=[];for(let t=0;t<j.length;++t)Q=j[t],J=Q.datum,J[Z.x]=Q.x,J[Z.y]=Q.y,J[Z.fontFamily]=Q.fontFamily,J[Z.fontSize]=Q.fontSize,J[Z.fontStyle]=Q.fontStyle,J[Z.fontWeight]=Q.fontWeight,J[Z.angle]=nt(Q.rotate),J[Z.opacity]=Q.opacity,J[Z.visible]=Q.visible,J[Z.isFillingWord]=!1,J[Z.color]=Q.color,J[X]=`${Q.text}_${t}_keyword`,tt.push(J);const et=[];G.forEach(((t,e)=>{var i,n;const s=Object.assign({},t.datum);s[Z.x]=t.x,s[Z.y]=t.y,s[Z.fontFamily]=t.fontFamily,s[Z.fontSize]=t.fontSize,s[Z.fontStyle]=t.fontStyle,s[Z.fontWeight]=t.fontWeight,s[Z.angle]=nt(t.rotate),s[Z.opacity]=t.opacity,s[Z.visible]=t.visible,s[Z.isFillingWord]=!0,s[Z.color]=A?(null===(i=S.colorField)||void 0===i?void 0:i.field)===(null===(n=S.fillingColorField)||void 0===n?void 0:n.field)&&R?t.color:t.fillingColor:T.fillingColorList[~~(b.randomGenerator()*T.fillingColorList.length)],s[Y]=t.text,s[X]=`${t.text}_${e}_fillingWords`,et.push(s)})),this.options.onLayoutFinished&&this.options.onLayoutFinished({successedWords:U,failedWords:V}),this.progressiveResult=tt.concat(et)}release(){this.segmentationInput=null,this.data=null,this.progressiveResult=null,this.options=null}}(t);return n.layout(e),n.unfinished()?{progressive:n}:n.output()},t.wordcloudTransform=(t,e)=>{var i,n,s,o,r,a;if(t.size&&(t.size[0]<=0||t.size[1]<=0)){return E.getInstance().info("Wordcloud size dimensions must be greater than 0"),[]}const l=e,h=(null!==(i=t.size)&&void 0!==i?i:[500,500]).slice();h[0]=Math.floor(h[0]),h[1]=Math.floor(h[1]);const c=t.fontFamily?yi(t.fontFamily):"sans-serif",u=t.fontStyle?yi(t.fontStyle):"normal",g=t.fontWeight?yi(t.fontWeight):"normal",f=t.rotate?yi(t.rotate):0,p=yi(t.text),x=null!==(n=t.spiral)&&void 0!==n?n:"archimedean",y=t.padding?yi(t.padding):1,m=null!==(s=t.shape)&&void 0!==s?s:"square",v=null!==(o=t.shrink)&&void 0!==o&&o,M=null!==(r=t.enlarge)&&void 0!==r&&r,_=null!==(a=t.clip)&&void 0!==a&&a,b=t.minFontSize,w=t.randomVisible,S=t.as?Object.assign(Object.assign({},xi),t.as):xi,k=t.depth_3d,z=t.postProjection;let F=t.fontSize?yi(t.fontSize):14;const T=t.fontSizeRange;if(T&&!d(F)){const t=F,e=vi(Mi(t,l),T);F=i=>e(t(i))}let R=Xe;"fast"===t.layoutType?R=fi:"grid"===t.layoutType&&(R=gi);const L=new R(Object.assign(Object.assign({},t),{text:p,padding:y,spiral:x,shape:m,rotate:f,fontFamily:c,fontStyle:u,fontWeight:g,fontSize:F,shrink:v,clip:_,enlarge:M,minFontSize:b,random:w,outputCallback:e=>{const i=[];let n,s;for(let o=0,r=e.length;o<r;o++)s=e[o],n=s.datum,n[S.x]=s.x,n[S.y]=s.y,n[S.fontFamily]=s.fontFamily,n[S.fontSize]=s.fontSize,n[S.fontStyle]=s.fontStyle,n[S.fontWeight]=s.fontWeight,n[S.angle]=s.angle,"StereographicProjection"===z&&_i(h,s,n,S,k),t.dataIndexKey&&(n[t.dataIndexKey]=`${o}`),i.push(n);return i}}));return L.layout(l,{width:h[0],height:h[1]}),t.progressiveStep>0||t.progressiveTime>0?{progressive:L}:L.output()}}));
