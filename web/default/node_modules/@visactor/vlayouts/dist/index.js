      ...
      constructor(options) {
          ...
          this._getPadding = isNumber$1(options === null || options === void 0 ? void 0 : options.padding)
              ...
              : isArray$1(options === null || options === void 0 ? void 0 : options.padding)
                  ...
                  : () => 0;
          this._maxDepth = -1;
          this._valueField = (_a = options === null || options === void 0 ? void 0 : options.valueField) !== null && _a !== void 0 ? _a : 'value';
      }
      layout(data, config) {
          var _a;
          ...
          const nodes = [];
          const res = calculateNodeValue$1(data, nodes, 0, -1, null, this._getNodeKey, this._valueField);
  ...
  let Layout$1 = class Layout {
      ...
      doLayout() {
          ...
          const layoutConfig = {
              size: options.size,
              ratio: options.ratio || 0.8,
              measureCache: (_a = options.measureCache) !== null && _a !== void 0 ? _a : new MapWordMeasureCache(),
              shapeUrl: options.shape,
              random: typeof options.random === 'undefined' ? true : options.random,
              textLayoutTimes: (_b = options.textLayoutTimes) !== null && _b !== void 0 ? _b : 3,
              removeWhiteBorder: options.removeWhiteBorder,
              layoutMode: (_c = options.layoutMode) !== null && _c !== void 0 ? _c : 'default',
              fontSizeShrinkFactor: (_d = options.fontSizeShrinkFactor) !== null && _d !== void 0 ? _d : 0.8,
              stepFactor: (_e = options.stepFactor) !== null && _e !== void 0 ? _e : 1,
              importantWordCount: (_f = options.importantWordCount) !== null && _f !== void 0 ? _f : 10,
              globalShinkLimit: options.globalShinkLimit || 0.2,
              fontSizeEnlargeFactor: (_g = options.fontSizeEnlargeFactor) !== null && _g !== void 0 ? _g : 1.5,
              fillingRatio: (_h = options.fillingRatio) !== null && _h !== void 0 ? _h : 0.7,
              fillingTimes: (_j = options.fillingTimes) !== null && _j !== void 0 ? _j : 4,
              fillingXStep: options.fillingXRatioStep
                  ? Math.max(Math.floor(options.size[0] * options.fillingXRatioStep), 1)
                  : (_k = options.fillingXStep) !== null && _k !== void 0 ? _k : 4,
              fillingYStep: options.fillingYRatioStep
                  ? Math.max(Math.floor(options.size[1] * options.fillingYRatioStep), 1)
                  : (_l = options.fillingYStep) !== null && _l !== void 0 ? _l : 4,
              fillingInitialFontSize: options.fillingInitialFontSize,
              fillingDeltaFontSize: options.fillingDeltaFontSize,
              fillingInitialOpacity: (_m = options.fillingInitialOpacity) !== null && _m !== void 0 ? _m : 0.8,
              fillingDeltaOpacity: (_o = options.fillingDeltaOpacity) !== null && _o !== void 0 ? _o : 0.05,
              ...
              getFillingPadding: simpleField((_p = options.fillingPadding) !== null && _p !== void 0 ? _p : 0.4),
              fillingRotateList: (_q = options.fillingRotateList) !== null && _q !== void 0 ? _q : [0, 90],
              fillingDeltaFontSizeFactor: (_r = options.fillingDeltaFontSizeFactor) !== null && _r !== void 0 ? _r : 0.2,
              fillingColorList: options.fillingColorList || ['#537EF5'],
              sameColorList: false,
              minInitFontSize: (_s = options.minInitFontSize) !== null && _s !== void 0 ? _s : 10,
              minFontSize: (_t = options.minFontSize) !== null && _t !== void 0 ? _t : 4,
              minFillFontSize: (_u = options.minFillFontSize) !== null && _u !== void 0 ? _u : 2
          };
          ...
          const textKey = (_w = (_v = options.text) === null || _v === void 0 ? void 0 : _v.field) !== null && _w !== void 0 ? _w : 'textKey';
          const dataIndexKey = (_x = options.dataIndexKey) !== null && _x !== void 0 ? _x : 'defaultDataIndexKey';
