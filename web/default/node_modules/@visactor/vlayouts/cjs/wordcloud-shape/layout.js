...
class Layout {
    ...
    doLayout() {
        ...
        const layoutConfig = {
            size: options.size,
            ratio: options.ratio || .8,
            measureCache: null !== (_a = options.measureCache) && void 0 !== _a ? _a : new util_1.MapWordMeasureCache,
            shapeUrl: options.shape,
            ...
            getFillingPadding: (0, vutils_1.simpleField)(null !== (_p = options.fillingPadding) && void 0 !== _p ? _p : .4),
        ...
        cloud_shape_layout_1.default)(words, layoutConfig, segmentationOutput), textKey = null !== (_w = null === (_v = options.text) || void 0 === _v ? void 0 : _v.field) && void 0 !== _w ? _w : "textKey", dataIndexKey = null !== (_x = options.dataIndexKey) && void 0 !== _x ? _x : "defaultDataIndexKey", as = options.as ? Object.assign(Object.assign({}, OUTPUT), options.as) : OUTPUT;
        let w, t;
        const modKeywords = [];
