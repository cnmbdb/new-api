...
export class CartesianMarkLine extends BaseMarkLine {
    ...
    _markerLayout() {
        ...
        if ("type-step" === this._spec.type) {
            ...
            const {points: points, limitRect: limitRect} = updateAttrs;
            ...
            const markerComponentAttr = null !== (_c = null === (_b = this._markerComponent) || void 0 === _b ? void 0 : _b.attribute) && void 0 !== _c ? _c : {}, prevLabelAttrs = array(markerComponentAttr.label), updateLabels = array(updateAttrs.label), labelsInSpec = array(this._spec.label);
