...
export class ScrollBar extends DataFilterBaseComponent {
    ...
    _handleChange(start, end, updateComponent) {
        ...
        if (this._shouldChange && (!isSameScrollValue || !1 === this._spec.realTime)) {
            ...
            const axis = this._relatedAxisComponent, reverse = isReverse(axis, this._isHorizontal), startValue = statePointToData(start, this._stateScale, reverse), endValue = statePointToData(end, this._stateScale, reverse);
