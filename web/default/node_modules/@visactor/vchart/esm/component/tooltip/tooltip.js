...
export class Tooltip extends BaseComponent {
    constructor() {
        ...
        this._mountEvent = (eType, query, callback) => {
            ...
            !0 === success.mark || !0 === success.group || !0 === success.dimension && !isNil(dimensionInfo) ? this._initEventOfTooltipContent() : this._cacheActiveType && "unShowByOption" === success[this._cacheActiveType] || this._handleChartMouseOut(params);
    ...
    _showContentByEvent(activeType) {
        ...
        if (null === (_a = this._option) || void 0 === _a ? void 0 : _a.componentShowContent) {
            ...
            if (isObject(this._option.componentShowContent.tooltip) && !1 === this._option.componentShowContent.tooltip[activeType]) return !1;
        }
        return !0;
    }
    reInit(spec) {
