...
export class BaseCrossHair extends BaseComponent {
    ...
    _registerEvent(eventName, isOut, click) {
        var _a;
        if (!1 === (null === (_a = this._option.componentShowContent) || void 0 === _a ? void 0 : _a.crosshair)) return;
    ...
    _getAxisInfoByField(field) {
        ...
        return bindingAxesIndex.forEach((idx => {
            ...
            if (!axis) return;
            const innerOffset = (null === (_b = (_a = axis).getInnerOffset) || void 0 === _b ? void 0 : _b.call(_a)) || {
                left: 0,
                right: 0,
                top: 0,
                bottom: 0
            ...
            axis.getRegions().forEach((r => {
                ...
                x1 = Math.min(x1, regionStartX - sx + innerOffset.left), y1 = Math.min(y1, regionStartY - sy + innerOffset.top), 
