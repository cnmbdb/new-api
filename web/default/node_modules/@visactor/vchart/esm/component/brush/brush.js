...
export class Brush extends BaseComponent {
    ...
    _createBrushComponent(region, componentIndex) {
        ...
        brush.addEventListener(BrushEvent.brushActive, (e => {
            ...
            this._setRegionMarkPickable(region, !0), this._emitEvent(ChartEvent.brushStart, region, e);
            ...
            this._initMarkBrushState(componentIndex, ""), this._emitEvent(ChartEvent.brushClear, region, e)) : (this._spec.onBrushEnd(e), 
            this._emitEvent(ChartEvent.brushEnd, region, e)); else {
