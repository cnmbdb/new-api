...
export class AxisComponent extends BaseComponent {
    ...
    constructor(spec, options) {
        ...
        this._visible = !0, this._specVisible = !0, this._hideWhenEmpty = !1, this._tick = void 0, 
        this._onTickDataChange = tickData => {
            this._forceLayout(), null == tickData || tickData.updateData();
        }, this._specVisible = null === (_a = spec.visible) || void 0 === _a || _a, this._hideWhenEmpty = null !== (_b = spec.hideWhenEmpty) && void 0 !== _b && _b, 
        this._visible = this._specVisible, this._coordinateType = "none";
    }
    setAttrFromSpec() {
        var _a, _b;
        super.setAttrFromSpec(), this._specVisible = null === (_a = this._spec.visible) || void 0 === _a || _a, 
        this._hideWhenEmpty = null !== (_b = this._spec.hideWhenEmpty) && void 0 !== _b && _b, 
        this._visible = this._specVisible, this._scale && this._refreshVisibilityByData();
    }
    ...
    created() {
        ...
        this.updateSeriesScale(), this._refreshVisibilityByData(), this._shouldComputeTickData() && this._initData(), 
        this._specVisible) {
            ...
            if (this._syncComponentVisibility(), (null === (_h = this._option.globalInstance) || void 0 === _h ? void 0 : _h.isAnimationEnable()) && !1 !== get(this._option.getChart().getSpec(), "animation") && !0 === this._spec.animation) {
    ...
    _refreshVisibilityByData() {
        const nextVisible = this._specVisible && (!this._hideWhenEmpty || this._hasCollectedSeriesData()), changed = this._visible !== nextVisible;
        return this._visible = nextVisible, (this._axisMark || this._gridMark) && this._syncComponentVisibility(), 
        changed && this._forceLayout(), changed;
    }
    _syncComponentVisibility() {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        null === (_a = this._axisMark) || void 0 === _a || _a.setVisible(this._visible), 
        null === (_b = this._gridMark) || void 0 === _b || _b.setVisible(this._visible && !1 !== (null === (_c = this._spec.grid) || void 0 === _c ? void 0 : _c.visible)), 
        null === (_g = null === (_f = null === (_e = null === (_d = this._axisMark) || void 0 === _d ? void 0 : _d.getComponent) || void 0 === _e ? void 0 : _e.call(_d)) || void 0 === _f ? void 0 : _f.setAttributes) || void 0 === _g || _g.call(_f, {
