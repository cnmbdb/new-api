...
export class VChart {
    ...
    constructor(spec, options) {
        ...
        }, this._observer = null, this._context = {}, this._renderState = RenderStateEnum.render, 
    ...
    updateDataSync(id, data, parserOptions, userUpdateOptions) {
        return this._reSetRenderState(), isNil(this._dataSet) ? this : this._chart ? (this._chart.updateData(id, data, !0, parserOptions), 
    ...
    _updateCurrentTheme(nextThemeName) {
        ...
        this._currentTheme = processThemeByChartType(chartType, currentTheme); else {
            const finalTheme = mergeTheme({}, getThemeObject(isObject(specTheme) && specTheme.type ? specTheme.type : isObject(optionTheme) && optionTheme.type ? optionTheme.type : this._currentThemeName), getThemeObject(optionTheme), getThemeObject(specTheme));
    ...
    runDisappearAnimation() {
        this._renderState = RenderStateEnum.disappear, this.getStage().eventSystem.pauseTriggerEvent(), 
