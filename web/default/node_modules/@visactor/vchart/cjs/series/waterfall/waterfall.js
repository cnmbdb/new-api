...
class WaterfallSeries extends bar_1.BarSeries {
    constructor() {
        ...
        this._reStackTotal = () => {
            const stackData = this.getStackData(), stackValueField = this.getStackValueField();
            stackData && (0, util_2.stackTotal)(stackData, stackValueField);
        };
    }
    getTotalData() {
        var _a;
    ...
    initMarkStyle() {
        ...
        this._leaderLineMark && ("horizontal" === this._direction ? this.setMarkStyle(this._leaderLineMark, {
