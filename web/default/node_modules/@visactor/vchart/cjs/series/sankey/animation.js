...
const factory_1 = require("../../core/factory"), config_1 = require("../../animation/config"), config_2 = require("../../animation/config"), vrender_animate_1 = require("@visactor/vrender-animate"), sankeyGrowIn = (params, isOverall = !0) => ({
...
const registerSankeyAnimation = () => {
    ...
    }, config_2.FadeInOutAnimation))), factory_1.Factory.registerAnimation("sankeyLinkPath", ((params, preset) => ({
