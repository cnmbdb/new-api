...
function computeTotalWithMultipleData(indexData, key, total, totalData, temp, indexValues, index, op, isTotalCheck) {
    ...
    if (indexData.forEach(((d, index) => {
        isTotalCheck(d) ? _totalTemp.push(Object.assign(Object.assign({}, d), {
            _vchart_waterfall_waterfall_temp: index
        })) : _normalTemp.push(d);
    ...
    const tempTotalValue = _normalTemp.reduce(((pre, cur) => (0, vutils_1.precisionSub)(pre, +cur[valueField])), valueTemp);
    return _totalTemp.forEach((d => {
        const tempTotalData = {
            [startAs]: start,
            [endAs]: end,
        ...
        d[startAs] = _d[startAs], d[endAs] = _d[endAs], d[valueField] = _d[valueField];
