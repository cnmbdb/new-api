...
class VChart {
    ...
    constructor(spec, options) {
        ...
        }, this._observer = null, this._context = {}, this._renderState = animate_1.RenderStateEnum.render, 
        this._disableDimensionHoverEvent = !1, this._doResize = () => {
    ...
    updateDataSync(id, data, parserOptions, userUpdateOptions) {
        return this._reSetRenderState(), (0, util_1.isNil)(this._dataSet) ? this : this._chart ? (this._chart.updateData(id, data, !0, parserOptions), 
    ...
    updateFullDataSync(data, reRender = !0, userUpdateOptions) {
        if (this._reSetRenderState(), this._chart) return this._chart.updateFullData(data), 
        reRender && ((null == userUpdateOptions ? void 0 : userUpdateOptions.reAnimate) && (this.stopAnimation(), 
    ...
    _updateCurrentTheme(nextThemeName) {
        ...
        common_2.getThemeObject)(this._currentThemeName), this._currentTheme = processThemeByChartType(chartType, currentTheme); else {
            const finalTheme = (0, theme_1.mergeTheme)({}, (0, common_2.getThemeObject)((0, 
            vutils_1.isObject)(specTheme) && specTheme.type ? specTheme.type : (0, vutils_1.isObject)(optionTheme) && optionTheme.type ? optionTheme.type : this._currentThemeName), (0, 
    ...
    runDisappearAnimation() {
        this._renderState = animate_1.RenderStateEnum.disappear, this.getStage().eventSystem.pauseTriggerEvent(), 
    ...
    _reSetRenderState() {
        this._renderState = animate_1.RenderStateEnum.render, this.getStage().eventSystem.resumeTriggerEvent();
    }
}
