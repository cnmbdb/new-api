...
class BaseMark extends grammar_item_1.GrammarItem {
    ...
    _computeGradientAttr(gradientStyle) {
        ...
        const themeColor = (0, util_1.computeActualDataScheme)((0, util_1.getDataScheme)(this.model.getColorScheme(), "series" === this.model.modelType ? null === (_b = (_a = this.model).getSpec) || void 0 === _b ? void 0 : _b.call(_a) : void 0), null !== (_e = null === (_d = null === (_c = this.model) || void 0 === _c ? void 0 : _c.getDefaultColorDomain) || void 0 === _d ? void 0 : _d.call(_c)) && void 0 !== _e ? _e : []), mergedStyle = Object.assign(Object.assign({}, gradient_1.DEFAULT_GRADIENT_CONFIG[gradient]), rest);
        return data => {
    ...
    _runApplyGraphic(graphics) {
        ...
        graphics.forEach(((g, index) => {
            ...
            if (g.setAttributes) {
                ...
                g.context = mockGraphic.context, g.context.diffAttrs = finalAttrs, g.stateSort = this._stateSort;
    ...
    render() {
        this.isCommited() && (!this.getVisible() || this._skipBeforeLayouted && this.getCompiler().getLayoutState() === interface_2.LayoutState.before || (this._product || this._initProduct(), 
        (0, debug_1.log)(`render mark: ${this.getProductId()}, type is ${this.type}`), this.renderInner()), 
        this.uncommit());
    }
    updateMarkState(key) {
