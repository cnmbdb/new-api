...
const type_1 = require("../../series/interface/type"), box_plot_1 = require("../../series/box-plot/box-plot"), factory_1 = require("../../core/factory"), box_plot_transformer_1 = require("./box-plot-transformer"), base_1 = require("../base"), dimension_hover_1 = require("../../interaction/triggers/dimension-hover"), events_1 = require("../../event/events"), cartesian_1 = require("../../event/events/dimension/util/cartesian"), cartesian_2 = require("../../component/crosshair/utils/cartesian"), dimension_tooltip_1 = require("../../component/tooltip/processor/dimension-tooltip"), mark_tooltip_1 = require("../../component/tooltip/processor/mark-tooltip"), vdataset_1 = require("@visactor/vdataset");
...
const registerBoxplotChart = () => {
    ...
    (0, box_plot_1.registerBoxplotSeries)(), factory_1.Factory.registerTransform("boxplot", vdataset_1.boxplot), 
    factory_1.Factory.registerChart(BoxPlotChart.type, BoxPlotChart);
};
