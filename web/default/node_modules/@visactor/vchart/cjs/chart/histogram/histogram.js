...
const bar_1 = require("../../series/bar/bar"), type_1 = require("../../series/interface/type"), base_1 = require("./base/base"), factory_1 = require("../../core/factory"), histogram_transformer_1 = require("./histogram-transformer"), dimension_hover_1 = require("../../interaction/triggers/dimension-hover"), events_1 = require("../../event/events"), cartesian_1 = require("../../event/events/dimension/util/cartesian"), cartesian_2 = require("../../component/crosshair/utils/cartesian"), dimension_tooltip_1 = require("../../component/tooltip/processor/dimension-tooltip"), mark_tooltip_1 = require("../../component/tooltip/processor/mark-tooltip"), group_tooltip_1 = require("../../component/tooltip/processor/group-tooltip"), vdataset_1 = require("@visactor/vdataset");
...
const registerHistogramChart = () => {
    ...
    (0, dimension_hover_1.registerDimensionHover)(), (0, bar_1.registerBarSeries)(), 
    factory_1.Factory.registerTransform("bin", vdataset_1.bin), factory_1.Factory.registerChart(HistogramChart.type, HistogramChart);
};
