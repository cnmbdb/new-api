...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.registerElementSelect = exports.ElementSelect = void 0;

const vutils_1 = require("@visactor/vutils"), interface_1 = require("../../compile/mark/interface"), base_1 = require("./base"), util_1 = require("./util"), factory_1 = require("../../core/factory"), defaultOptions = {
    state: interface_1.STATE_VALUE_ENUM.STATE_SELECTED,
    trigger: "click"
};
...
class ElementSelect extends base_1.BaseTrigger {
    ...
    getEvents() {
        ...
        } ], {eventNames: eventNames, resetType: resetType} = (0, util_1.parseTriggerOffOfSelect)(triggerOff);
...
exports.ElementSelect = ElementSelect, ElementSelect.type = "element-select", ElementSelect.defaultOptions = defaultOptions;

const registerElementSelect = () => {
    factory_1.Factory.registerInteractionTrigger(ElementSelect.type, ElementSelect);
};
