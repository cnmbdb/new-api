...
class ScrollBar extends data_filter_base_component_1.DataFilterBaseComponent {
    ...
    _handleChange(start, end, updateComponent) {
        ...
        if (this._shouldChange && (!isSameScrollValue || !1 === this._spec.realTime)) {
            ...
            const axis = this._relatedAxisComponent, reverse = (0, util_2.isReverse)(axis, this._isHorizontal), startValue = (0, 
            util_2.statePointToData)(start, this._stateScale, reverse), endValue = (0, util_2.statePointToData)(end, this._stateScale, reverse);
