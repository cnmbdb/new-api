...
class GeoCoordinate extends base_component_1.BaseComponent {
    constructor() {
        ...
        this.layoutType = "none", this.layoutZIndex = layout_1.LayoutZIndex.Mark, this._projectionSpec = {
            ...
            const rate = (0, vutils_1.isValid)(this._spec.zoomRate) ? Math.max(0, this._spec.zoomRate) : 1, delta = Math.max(params.zoomDelta, 1e-6);
            ...
            r.getSeries().forEach((s => {
                ...
                if ("map" === s.type) {
                    (null !== (_b = null === (_a = s.getMapViewData()) || void 0 === _a ? void 0 : _a.latestData) && void 0 !== _b ? _b : []).forEach(((feature = {}) => {
                        const key = feature[s.getDimensionField()[0]] || feature[data_1.DEFAULT_MAP_LOOK_UP_KEY], center = s.getDatumCenter(feature);
    ...
    _compareSpec(spec, prevSpec) {
        ...
        return result.reMake || (result.reMake = [ "roam", "longitudeField", "latitudeField", "projection", "zoomLimit", "zoomRate" ].some((k => !(0, 
