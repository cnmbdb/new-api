...
class Tooltip extends base_component_1.BaseComponent {
    constructor() {
        ...
        this.specKey = "tooltip", this.layoutType = "none", this._isReleased = !1, this.enable = !0, 
        this._alwaysShow = !1, this._eventList = [], this._isTooltipShown = !1, this._clickLock = !1, 
        this._mountEvent = (eType, query, callback) => {
            ...
            var _a;
            this._cacheActiveType && (null === (_a = this._option) || void 0 === _a ? void 0 : _a.componentShowContent) && (!1 === this._option.componentShowContent.tooltip || (0, 
            vutils_1.isObject)(this._option.componentShowContent.tooltip) && !1 === this._option.componentShowContent.tooltip[this._cacheActiveType]) || this._alwaysShow || this._isReleased || this._isEnterTooltip || "none" !== this._spec.triggerOff && (this._hideTooltipByHandler(Object.assign(Object.assign({}, params), {
                tooltip: this
            ...
            for (let i = 0, len = supportedTooltip.length; i < len; i++) {
                const type = supportedTooltip[i], res = !!this.processor[type] && this._showTooltipByMouseEvent(type, mouseEventData, params, isClick);
                if ("unShowByOption" === res) success[type] = "unShowByOption"; else if (res) {
                    success[type] = !0;
                    break;
                }
            }
            ...
            !0 === success.mark || !0 === success.group || !0 === success.dimension && !(0, 
            vutils_1.isNil)(dimensionInfo) ? this._initEventOfTooltipContent() : this._cacheActiveType && "unShowByOption" === success[this._cacheActiveType] || this._handleChartMouseOut(params);
        }, this._showTooltipByMouseEvent = (activeType, mouseEventData, params, isClick, useCache) => {
            var _a;
            if (!this._showContentByEvent(activeType)) return "unShowByOption";
    ...
    _showContentByEvent(activeType) {
        var _a;
        if (null === (_a = this._option) || void 0 === _a ? void 0 : _a.componentShowContent) {
            if (!1 === this._option.componentShowContent.tooltip) return !1;
            if ((0, vutils_1.isObject)(this._option.componentShowContent.tooltip) && !1 === this._option.componentShowContent.tooltip[activeType]) return !1;
        }
        return !0;
    }
    reInit(spec) {
        ...
        if (super.reInit(spec), this.tooltipHandler) {
            ...
            null === (_c = null === (_b = this.tooltipHandler) || void 0 === _b ? void 0 : _b.reInit) || void 0 === _c || _c.call(_b);
    ...
    showTooltip(datum, options) {
        ...
        this._cacheActiveType = result), result;
    }
