...
class BaseTooltipProcessor {
    ...
    shouldHandleTooltip(params, info) {
        var _a, _b;
        return !!this.component.enable && (!(0, vutils_1.isNil)(info) && (0, common_1.isActiveTypeVisible)(this.activeType, null === (_b = null === (_a = params.model) || void 0 === _a ? void 0 : _a.tooltipHelper) || void 0 === _b ? void 0 : _b.spec));
    }
    clearCache() {
