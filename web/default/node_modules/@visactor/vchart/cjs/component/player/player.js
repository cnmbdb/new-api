...
class Player extends base_component_1.BaseComponent {
    constructor() {
        ...
        this._getPlayerAttrs = () => {
            ...
            this._option.disableTriggerEvent || (this._option.globalInstance.off(event_1.ChartEvent.rendered, this.autoPlayCallback), 
            this._option.globalInstance.on(event_1.ChartEvent.rendered, this.autoPlayCallback), 
    ...
    release() {
        this._option.globalInstance.off(event_1.ChartEvent.rendered, this.autoPlayCallback);
    }
}
