...
function transformHandlerText(handlerText) {
    ...
    const nextHandlerText = Object.assign({}, handlerText), handlerTextStyle = handlerText.style;
    return (0, vutils_1.isFunction)(handlerTextStyle) ? nextHandlerText.style = (value, position, context) => (0, 
    style_1.transformToGraphic)(handlerTextStyle(value, position, context)) : (0, vutils_1.isEmpty)(handlerTextStyle) || (nextHandlerText.style = (0, 
    style_1.transformToGraphic)(handlerTextStyle)), nextHandlerText;
}
...
function getContinuousLegendAttributes(spec) {
    ...
    attrs.endText = (0, style_1.transformComponentStyle)(endText), attrs.handlerText = transformHandlerText(handlerText), 
    (0, vutils_1.isEmpty)(sizeBackground) || (attrs.sizeBackground = (0, style_1.transformToGraphic)(sizeBackground)), 
    background.visible && !(0, vutils_1.isEmpty)(background.style) && ((0, vutils_extension_1.mergeSpec)(attrs, background.style), 
