...
class AxisComponent extends base_component_1.BaseComponent {
    ...
    created() {
        ...
        this._specVisible) {
            ...
            if (this._syncComponentVisibility(), (null === (_h = this._option.globalInstance) || void 0 === _h ? void 0 : _h.isAnimationEnable()) && !1 !== (0, 
    ...
    collectData(depth, rawData) {
        const data = [];
        return this._regions && (0, model_1.eachSeries)(this._regions, (s => {
            var _a;
