...
class CartesianAxis extends base_axis_1.AxisComponent {
    ...
    _getUpdateAttribute(ignoreGrid) {
        ...
        const items = this.getLabelItems(axisLength), attrs = {
            ...
            width: this._spec.width ? this.getLayoutRect().width : void 0
        };
    ...
    initEvent() {
        super.initEvent(), this._specVisible && (this.event.on(event_1.ChartEvent.layoutEnd, this._updateAxisLayout), 
