...
class CartesianMarkArea extends base_mark_area_1.BaseMarkArea {
    ...
    _computePointsAttr() {
        ...
        utils_1.getMarkAreaProcessInfo)(spec), isPositionLayout = (0, vutils_1.isValid)(spec.positions), autoRange = null !== (_a = spec.autoRange) && void 0 !== _a && _a, includeFullBand = null !== (_b = spec.includeFullBand) && void 0 !== _b && _b;
        let points = [], lines = [];
        if (doXYProcess) {
            lines = (0, utils_1.xyLayout)(data, startRelativeSeries, endRelativeSeries, relativeSeries, autoRange, includeFullBand);
