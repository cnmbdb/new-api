...
const vchart_1 = require("@visactor/vchart"), vchart_2 = require("@visactor/vchart"), util_1 = require("./util");

class VChart3dPlugin extends vchart_2.BasePlugin {
    constructor() {
...
const register3DPlugin = () => {
    (0, vchart_2.registerChartPlugin)(VChart3dPlugin), (0, vchart_1.registerDirectionalLight)(), 
    (0, vchart_1.registerOrthoCamera)(), (0, vchart_1.registerViewTransform3dPlugin)();
};
