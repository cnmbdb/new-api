...
const registerCandlestickMark = () => {
    (0, vchart_1.registerGlyphMark)(), (0, vchart_1.registerLine)(), (0, vchart_1.registerRect)(), 
    vchart_2.Factory.registerGraphicComponent("line", (attrs => (0, vchart_1.createLine)(attrs))), 
    vchart_2.Factory.registerGraphicComponent("rect", (attrs => (0, vchart_1.createRect)(attrs))), 
