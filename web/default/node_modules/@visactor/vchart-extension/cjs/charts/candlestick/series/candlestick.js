...
const candlestick_1 = require("../mark/candlestick"), vchart_1 = require("@visactor/vchart"), vchart_2 = require("@visactor/vchart"), vchart_3 = require("@visactor/vchart"), animation_1 = require("./animation"), constant_1 = require("./constant"), tooltip_helper_1 = require("./tooltip-helper"), theme_1 = require("./theme");
...
class CandlestickSeries extends vchart_1.CartesianSeries {
    ...
    _initAnimationSpec(config = {}) {
        const newConfig = (0, vchart_3.merge)({}, config);
    ...
    _buildMergedStyles(baseStyle, risingStyle, fallingStyle, dojiStyle) {
        this._mergedStyles.rising = (0, vchart_3.merge)({}, baseStyle, risingStyle), this._mergedStyles.falling = (0, 
        vchart_3.merge)({}, baseStyle, fallingStyle), this._mergedStyles.doji = (0, vchart_3.merge)({}, baseStyle, dojiStyle);
    }
    mergeStyle(datum) {
