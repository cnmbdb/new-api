...
const vchart_1 = require("@visactor/vchart"), util_1 = require("./util"), conversionArrowTransform = (arrowSpec, options) => {
    var _a, _b, _c;
...
function parseArrow(arrows, categoryField) {
    return arrows.filter((arrow => (0, vchart_1.isValidNumber)(arrow.from * arrow.to))).map(((arrow, index) => {
...
function computeArrows(arrows) {
    ...
    return arrows.forEach((arrow => {
        ...
        if ((0, vchart_1.isValid)(fromNodeDegree)) {
        ...
        if ((0, vchart_1.isValid)(toNodeDegree)) {
        ...
        vchart_1.maxInArray)(arrowsIsLayout, ((cur, curMax) => cur.layout.level - curMax.layout.level));
