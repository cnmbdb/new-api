...
function isValidStrokeOrFill(attr) {
    var _a;
    return (0, vchart_1.isValid)(attr) && "none" !== attr && !(null === (_a = attr.includes) || void 0 === _a ? void 0 : _a.call(attr, "url"));
}
...
const pictogram = data => {
    ...
    if (elements && elements.length) {
        elements.forEach(((el, index) => {
            var _a;
            el[vchart_2.DEFAULT_DATA_INDEX] = index, el._uniqueId = `${el.id}-${index}`, el.data = void 0;
            ...
            "text" === el.graphicType ? (0, vchart_1.merge)(finalAttributes, el._inheritStyle, null === (_a = el.parent) || void 0 === _a ? void 0 : _a._textGroupStyle, el.attributes) : "group" !== el.graphicType && (0, 
            vchart_1.merge)(finalAttributes, el._inheritStyle, el.attributes), exports.graphicAttributeTransform[type] ? el._finalAttributes = exports.graphicAttributeTransform[type](finalAttributes, el.value) : el._finalAttributes = finalAttributes, 
            ...
            if (children && children.length) {
                ...
                for (let j = 0; j < children.length; j++) {
                    ...
                    if ("group" === currentChild.graphicType) curX = startX; else if (currentChild.value && void 0 === currentChild.parent._textGroupStyle.x) {
                        ...
                        if (lastText) {
                            curX += (0, vchart_2.measureText)(lastText.value, lastText._finalAttributes).width;
                        }
