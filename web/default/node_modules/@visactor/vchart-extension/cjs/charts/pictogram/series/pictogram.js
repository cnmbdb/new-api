...
const vchart_1 = require("@visactor/vchart"), constant_1 = require("./constant"), svg_source_1 = require("./svg-source"), pictogram_transformer_1 = require("./pictogram-transformer"), vchart_2 = require("@visactor/vchart"), vchart_3 = require("@visactor/vchart"), tooltip_helper_1 = require("./tooltip-helper"), vchart_4 = require("@visactor/vchart"), element_highlight_by_graphic_name_1 = require("../element-highlight-by-graphic-name"), element_select_by_graphic_name_1 = require("../element-select-by-graphic-name"), transform_1 = require("./transform");

class PictogramSeries extends vchart_4.GeoSeries {
    constructor() {
    ...
    _defaultHoverConfig(finalHoverSpec) {
        return {
            ...
            blurState: vchart_4.STATE_VALUE_ENUM.STATE_HOVER_REVERSE,
            highlightState: vchart_4.STATE_VALUE_ENUM.STATE_HOVER
        };
    }
    _defaultSelectConfig(finalSelectSpec) {
        const isMultiple = "multiple" === finalSelectSpec.mode, triggerOff = (0, vchart_2.isValid)(finalSelectSpec.triggerOff) ? finalSelectSpec.triggerOff : isMultiple ? [ "empty", "self" ] : [ "empty", finalSelectSpec.trigger ];
        return {
            type: constant_1.ELEMENT_SELECT_BY_GRPHIC_NAME,
            trigger: finalSelectSpec.trigger,
            triggerOff: triggerOff,
            reverseState: vchart_4.STATE_VALUE_ENUM.STATE_SELECTED_REVERSE,
            state: vchart_4.STATE_VALUE_ENUM.STATE_SELECTED,
    ...
    initMark() {
        ...
        if (this._pictogramMark = this._createMark(PictogramSeries.mark.pictogram, {
            ...
            morph: (0, vchart_4.shouldMarkDoMorph)(this._spec, PictogramSeries.mark.pictogram.name)
        }), this._pictogramMark) {
    ...
    initLabelMarkStyle() {
        this._labelMark && this.setMarkStyle(this._labelMark, {
            ...
            textAlign: "center",
            textBaseline: "middle"
        }, vchart_4.STATE_VALUE_ENUM.STATE_NORMAL, vchart_4.AttributeLevel.Series);
    }
    initMarkStyle() {
        const {root: root, viewBoxRect: viewBoxRect} = this._parsedSvgResult, elements = this._mapViewData.getDataView().latestData;
        root && (this.setMarkStyle(this._pictogramMark, transform_1.graphicAttributeTransform.group(root.attributes), "normal", vchart_4.AttributeLevel.Built_In), 
        root.transform && this.setMarkStyle(this._pictogramMark, {
            postMatrix: () => root.transform
        }, "normal", vchart_4.AttributeLevel.Built_In), viewBoxRect && this._pictogramMark.setMarkConfig({
            clip: !0,
            clipPath: [ (0, vchart_3.createRect)(Object.assign(Object.assign({}, viewBoxRect), {
                fill: !0
            })) ]
        }));
        for (const element of elements) {
            ...
            mark && (this.setMarkStyle(mark, {
                keepStrokeScale: !0
            }, "normal", vchart_4.AttributeLevel.Built_In), valid ? (this.initMarkStyleWithSpec(mark, (0, 
            vchart_2.merge)({}, this._spec.pictogram, this._spec[mark.name])), this.setMarkStyle(mark, attributes, "normal", vchart_4.AttributeLevel.Series), 
            mark.setPostProcess("fill", ((result, datum) => (0, vchart_2.isValid)(result) ? result : this._spec.defaultFillColor))) : (mark.setMarkConfig({
                interactive: !1
            }), this.setMarkStyle(mark, attributes, "normal", vchart_4.AttributeLevel.Built_In)));
        }
    ...
    dataToPosition(datum, global = !1) {
        ...
        let bounds = new vchart_2.Bounds;
    ...
    initData() {
        ...
        const svgData = new vchart_1.DataView(this._dataSet, {
            name: `pictogram_${this.id}_data`
        });
        (0, vchart_4.registerDataSetInstanceTransform)(this._dataSet, "pictogram", transform_1.pictogram), 
        (0, vchart_4.registerDataSetInstanceTransform)(this._dataSet, "lookup", vchart_4.lookup), 
        ...
        this._mapViewData = new vchart_4.CompilableData(this._option, svgData);
    }
    mapViewDataUpdate() {
    ...
    initEvent() {
        ...
        this.event.on(vchart_4.ChartEvent.afterMarkLayoutEnd, this.updateSVGSize.bind(this));
    }
    handleZoom(e) {
        ...
        root && (root.attribute.postMatrix || root.setAttributes({
            postMatrix: new vchart_2.Matrix
...
const registerPictogramSeries = () => {
    vchart_4.Factory.registerSeries(PictogramSeries.type, PictogramSeries), vchart_4.Factory.registerImplement("registerSVG", svg_source_1.registerSVGSource), 
    vchart_4.Factory.registerImplement("unregisterSVG", svg_source_1.unregisterSVGSource), 
