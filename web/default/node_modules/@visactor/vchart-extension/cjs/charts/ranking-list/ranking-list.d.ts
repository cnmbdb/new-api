...
export declare class RankingList extends BaseChart<Omit<IRankingListSpec, 'data'>> {
    ...
    _spec: IRankingListSpec;
    static readonly transformerConstructor: typeof RankingListChartSpecTransformer;
    readonly transformerConstructor: typeof RankingListChartSpecTransformer;
    init(): void;
    protected isValid(): boolean;
}
export declare const registerRankingList: (option?: {
