...
const vchart_1 = require("@visactor/vchart"), vchart_2 = require("@visactor/vchart"), constant_1 = require("./constant"), utils_1 = require("./utils"), DATA_KEY = "dataKey", ORDER_KEY = "VCHART_ORDER", SUPPLY_DATA_KEY = "SUPPLY_DATA_KEY", NAME_LABEL_PADDING_RIGHT = 10, NAME_ORDER_PADDING_RIGHT = 5, NAME_SYMBOL_PADDING_RIGHT = 8, CHART_PADDING_LEFT = 5, CHART_PADDING_RIGHT = 5, VALUE_LABEL_PADDING_LEFT = 5, LABEL_PADDING_BOTTOM = 5;
...
class RankingListChartSpecTransformer extends vchart_1.CommonChartSpecTransformer {
    ...
    upgradeTextMeasure(spec) {
        ...
        null === (_c = this.orderLabelTextMeasure) || void 0 === _c || _c.release(), this.nameLabelTextMeasure = new vchart_2.TextMeasure({
            defaultFontParams: null !== (_e = null === (_d = spec.nameLabel) || void 0 === _d ? void 0 : _d.style) && void 0 !== _e ? _e : {}
        }), this.valueLabelTextMeasure = new vchart_2.TextMeasure({
            defaultFontParams: null !== (_g = null === (_f = spec.valueLabel) || void 0 === _f ? void 0 : _f.style) && void 0 !== _g ? _g : {}
        }), this.orderLabelTextMeasure = new vchart_2.TextMeasure({
    ...
    processData(spec) {
        ...
        this.originalSpec = (0, vchart_2.cloneDeep)(spec), this.dataSpecs = this.processRankingData(spec), 
