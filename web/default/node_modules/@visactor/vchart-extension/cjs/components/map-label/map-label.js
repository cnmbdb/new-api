...
const vchart_1 = require("@visactor/vchart"), vchart_2 = require("@visactor/vchart"), vchart_3 = require("@visactor/vchart"), vchart_4 = require("@visactor/vchart"), layout_1 = require("./layout"), map_label_transformer_1 = require("./map-label-transformer");

class MapLabelComponent extends vchart_4.BaseComponent {
    constructor() {
        super(...arguments), this.type = "mapLabel", this.name = " mapLabel", this.specKey = "mapLabel", 
        this.transformerConstructor = map_label_transformer_1.MapLabelSpecTransformer, this.layoutType = "none", 
        this.layoutZIndex = vchart_4.LayoutZIndex.MarkPoint, this._activeDatum = [];
    }
    static getSpecInfo(chartSpec) {
        return (0, vchart_4.getSpecInfo)(chartSpec, this.specKey, this.type, (s => s.visible && (0, 
        vchart_3.isValid)(s.seriesId)));
    }
    setAttrFromSpec() {
        var _a, _b, _c, _d;
    ...
    initData() {
        ...
        if (seriesData) {
            const data = new vchart_1.DataView(this._option.dataSet, {
            ...
            data.parse([ seriesData ], {
                ...
                type: "copyDataView",
                level: vchart_4.TransformLevel.copyDataView
            }, !1), this._data = new vchart_4.CompilableData(this._option, data), data.target.addListener("change", (() => {
    ...
    initEvent() {
        ...
        "none" !== trigger && ("hover" === trigger ? (this.event.on("element-highlight:start", (params => {
            ...
            this._isRelativeSeries(g) && this._updateDatum((0, vchart_4.getDatumOfGraphic)(g));
    ...
    _updateMarkerLayoutAttribute() {
        ...
        this._markerComponents || (this._markerComponents = null === (_a = this._data) || void 0 === _a ? void 0 : _a.getLatestData().map(((data, index) => {
            var _a;
            const cmp = new vchart_2.MarkPoint({
                position: void 0,
                animation: !1
            });
    ...
    _evaluateMarker(data, index) {
        ...
        vchart_4.normalizeLayoutPaddingSpec)(null === (_a = this._spec.background) || void 0 === _a ? void 0 : _a.padding), space = this._spec.space || 0;
        ...
        const contentMarks = {}, positionAttr = this.dataToPosition(data), container = vchart_2.graphicCreator.group({});
        ...
        null === (_b = this._spec.background) || void 0 === _b ? void 0 : _b.visible) {
            const labelBackground = vchart_2.graphicCreator.rect((0, vchart_4.transformToGraphic)(Object.assign({}, this._spec.background.style)));
        ...
        if (null === (_c = this._spec.icon) || void 0 === _c ? void 0 : _c.visible) {
            const icon = vchart_2.graphicCreator.symbol((0, vchart_4.transformToGraphic)(Object.assign({}, this._spec.icon.style)));
        ...
        if (null === (_j = this._spec.nameLabel) || void 0 === _j ? void 0 : _j.visible) {
            const nameLabel = vchart_2.graphicCreator.text((0, vchart_4.transformToGraphic)(Object.assign({}, this._spec.nameLabel.style)));
        ...
        if ((null === (_m = this._spec.valueLabel) || void 0 === _m ? void 0 : _m.visible) && (0, 
        vchart_3.isValid)(data[this.valueField])) {
            const valueLabel = vchart_2.graphicCreator.text((0, vchart_4.transformToGraphic)(Object.assign({}, this._spec.valueLabel.style)));
    ...
    _layoutMarkers(positionedRects, contentMarks) {
        ...
        for (let i = 0; i < contentMarks.length; i++) {
            ...
            vchart_4.normalizeLayoutPaddingSpec)(null === (_a = this._spec.background) || void 0 === _a ? void 0 : _a.padding), space = this._spec.space || 0, curY = itemRect.height / 2;
            ...
            this._markerComponents[i].setAttributes({
                ...
                itemLine: {
                    visible: showLeader,
                    type: "type-po",
                    lineStyle: (0, vchart_4.transformToGraphic)(Object.assign({}, null === (_c = this._spec.leader) || void 0 === _c ? void 0 : _c.style)),
                    startSymbol: {
                        visible: !1
                    }
                }
...
exports.MapLabelComponent = MapLabelComponent, MapLabelComponent.type = "mapLabel", 
MapLabelComponent.specKey = "mapLabel", MapLabelComponent.transformerConstructor = map_label_transformer_1.MapLabelSpecTransformer;

const registerMapLabel = option => {
    const vchartConstructor = (null == option ? void 0 : option.VChart) || vchart_4.VChart;
