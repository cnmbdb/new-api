...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.registerSeriesLabel = exports.SeriesLabelComponent = void 0;

const vchart_1 = require("@visactor/vchart"), vchart_2 = require("@visactor/vchart"), vchart_3 = require("@visactor/vchart"), util_1 = require("./util"), constant_1 = require("./constant");

class SeriesLabelComponent extends vchart_1.AbstractComponent {
    constructor() {
        super(...arguments), this.name = constant_1.SERIES_LABEL;
    }
    render() {
        var _a, _b, _c, _d;
        this.removeAllChild();
        ...
        if ("vertical" === layout) {
            const lineHeight = 1.5 * (null !== (_c = null === (_b = null == label ? void 0 : label.style) || void 0 === _b ? void 0 : _b.fontSize) && void 0 !== _c ? _c : 12), createAndAddTextGraphic = (datum, textPoint, labelStyleMap) => {
                ...
                const {label: text, color: color, textAlign: textAlign, textBaseline: textBaseline, id: id} = datum, formatMethod = null !== (_b = null === (_a = labelStyleMap[id]) || void 0 === _a ? void 0 : _a.formatMethod) && void 0 !== _b ? _b : null === (_c = this.attribute.label) || void 0 === _c ? void 0 : _c.formatMethod, textGraphic = (0, 
                vchart_1.createText)(Object.assign(Object.assign(Object.assign(Object.assign({
            ...
            [ "start", "end" ].forEach((position => {
                const posData = filteredData.filter((datum => datum.position === position)), posYArr = posData.map((datum => datum.point.y)), dodgedPosY = (0, 
                util_1.dodge)(posYArr, lineHeight);
            ...
            filteredData.forEach((datum => {
                ...
                const {point: point, label: text, color: color, textAlign: textAlign, textBaseline: textBaseline, id: id, position: position} = datum, textPoint = {
                    x: point.x,
                    y: point.y
                }, formatMethod = null !== (_b = null === (_a = labelStyleMap[id]) || void 0 === _a ? void 0 : _a.formatMethod) && void 0 !== _b ? _b : null == label ? void 0 : label.formatMethod, textGraphic = (0, 
                vchart_1.createText)(Object.assign(Object.assign(Object.assign(Object.assign({
                    text: formatMethod ? formatMethod(text, datum.datum, {
                        series: datum.series
                    }) : text
            ...
            })), startTexts.length && (0, util_1.dodgeHorizontal)(startTexts, 4, 10), endTexts.length && (0, 
            util_1.dodgeHorizontal)(endTexts, 4, 10);
        ...
        !1 !== line.visible && filteredData.forEach((datum => {
            ...
            if (!1 !== line.autoVisible) {
                if ("vertical" === layout && start.y !== end.y || "horizontal" === layout && start.x !== end.x) {
                    const lineShape = (0, vchart_1.createLine)(Object.assign({
                        points: [ start, end ],
                        lineWidth: 1,
                        stroke: color
                    }, line.style));
