            ...
            data: (datum, ctx) => {
                ...
                if (1 === seriesTypes.length && [ "bar", "area", "line", "waterfall" ].includes(seriesTypes[0])) {
                    ("both-ends" === position ? [ "start", "end" ] : [ position ]).forEach((pos => {
                        const targetValue = "end" === pos ? (0, vchart_1.last)(bandAxisScale.domain()) : bandAxisScale.domain()[0], region = series.getRegion(), {x: regionStartX, y: regionStartY} = region.getLayoutStartPoint();
                        let i = 0;
...
function appendSeriesLabelConfig(rawSpec, seriesLabelSpec) {
    var _a, _b, _c;
    if (rawSpec.customMark = (0, vchart_1.array)(rawSpec.customMark).filter((obj => obj.componentType !== constant_1.SERIES_LABEL)), 
    seriesLabelSpec || (seriesLabelSpec = null !== (_c = null !== (_a = (0, vchart_1.get)(rawSpec, constant_1.SERIES_LABEL)) && void 0 !== _a ? _a : (0, 
    vchart_1.get)(null === (_b = rawSpec.series) || void 0 === _b ? void 0 : _b[0], constant_1.SERIES_LABEL)) && void 0 !== _c ? _c : {}), 
