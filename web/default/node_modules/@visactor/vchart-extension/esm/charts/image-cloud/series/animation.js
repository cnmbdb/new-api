...
export class AxialRotateAnimation extends ACustomAnimate {
    ...
    onBind() {
        this._scaleX = this.target.attribute.scaleX, isValidNumber(this._rotations) || (this.valid = !1);
    }
...
export function imageCloudPresetAnimation(params, preset) {
    switch (preset) {
      case "axialRotate":
        return [ {
...
export const registerImageCloudAnimation = () => {
    Factory.registerAnimation("imageCloud", ((params, preset) => ({
