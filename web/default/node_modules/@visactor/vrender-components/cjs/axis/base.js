...
class AxisBase extends animate_component_1.AnimateComponent {
    ...
    _getLabelAttribute(tickDatum, index, tickData, layer) {
        ...
        textStyle = (0, vutils_1.merge)(labelAlign, textStyle), (0, vutils_1.isFunction)(textStyle.text) && (textStyle.text = textStyle.text({
        ...
        return (0, vutils_1.isFunction)(reactStyle) && (reactStyle = reactStyle(tickDatum, index, tickData, layer)), 
        Object.assign(Object.assign(Object.assign(Object.assign({}, this.getLabelPosition(point, vector, textContent, textStyle)), {
