...
class Brush extends base_1.AbstractComponent {
    constructor(attributes, options) {
        ...
        this._brushMaskAABBBoundsDict = {}, this._firstUpdate = !0, this._onBrushStart = e => {
            ...
            this._firstUpdate = !1) : (this._activeDrawState && this._drawing(e), this._activeMoveState && this._moving(e))));
        ...
        this._onBrushEnd = e => {
            !1 !== this.attribute.interactive && (this._releaseBrushUpdateEvents(), e.preventDefault(), 
            this._activeDrawState && this._drawEnd(e), this._activeMoveState && this._moveEnd(e), 
            this._activeDrawState = !1, this._activeMoveState = !1);
        }, this._onBrushClear = e => {
            !1 !== this.attribute.interactive && !1 !== this._beforeBrushEvent(e) && (e.preventDefault(), 
            this._isEmptyMask() || (this._clearMask(), this._dispatchBrushEvent(type_1.IOperateType.brushClear, e)), 
            this._activeDrawState = !1, this._activeMoveState = !1);
        };
    }
    _bindBrushEvents() {
    ...
    _moveEnd(e) {
        !1 !== this.attribute.interactive && (this._operatingMask && this._operatingMask.setAttribute("pickable", !1), 
        this._dispatchBrushEvent(type_1.IOperateType.moveEnd, e));
    }
    render() {
