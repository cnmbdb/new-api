...
const useStyles = () => {
	...
	const loaderContainer = theme.isDarkMode ? "https://github.com/images/modules/pulls/progressive-disclosure-line-dark.svg" : "https://github.com/images/modules/pulls/progressive-disclosure-line.svg";
	const loadingImage = theme.isDarkMode ? "https://github.githubassets.com/images/mona-loading-dark.gif" : "https://github.githubassets.com/images/mona-loading-default.gif";
	const { styles } = css`
    main {
      ...
      --color-prettylights-syntax-invalid-illegal-bg: ${rgba(colorRed, .4)};
      --color-prettylights-syntax-carriage-return-text: ${colorTextSecondary};
      --color-prettylights-syntax-carriage-return-bg: ${rgba(colorRed, .6)};
      ...
      --color-prettylights-syntax-markup-deleted-bg: ${rgba(colorRed, .2)};
      --color-prettylights-syntax-markup-inserted-text: ${colorGreen};
      --color-prettylights-syntax-markup-inserted-bg: ${rgba(colorGreen, .2)};
      --color-prettylights-syntax-markup-changed-text: ${colorOrange};
      --color-prettylights-syntax-markup-changed-bg: ${rgba(colorRed, .2)};
      --color-prettylights-syntax-markup-ignored-text: ${colorTextSecondary};
      --color-prettylights-syntax-markup-ignored-bg: ${rgba(colorBlue, .2)};
...
const formatLang = (lang) => {
	if (["zh_CN", "zh_TW"].includes(lang)) return lang.replace("_", "-");
	else if (lang === "zh_HK") return "zh-TW";
	else return lang.split("_")[0];
};

//#endregion
export { formatLang, useStyles };
