...
//#region src/Highlighter/theme/lobe-theme.ts
var lobe_theme_default = {
	displayName: "Lobe Theme",
	name: "lobe-theme",
	semanticHighlighting: true,
	tokenColors: [
		{ settings: { foreground: cssVar.colorText } },
		{
			scope: "string",
			settings: { foreground: cssVar.colorSuccess }
		},
		{
			scope: "punctuation, constant.other.symbol",
			settings: { foreground: cssVar.colorInfo }
		},
		{
		...
		},
		{
			...
			settings: { foreground: cssVar.purple10 }
		},
		{
			scope: "constant.numeric",
			settings: { foreground: cssVar.volcano10 }
		},
		{
		...
		},
		{
			...
			settings: { foreground: cssVar.geekblue10 }
		},
		{
		...
		},
		{
			...
			settings: { foreground: cssVar.colorWarning }
		},
		{
		...
		},
		{
			...
			settings: { foreground: cssVar.colorTextSecondary }
		},
		{
		...
		},
		{
			...
			settings: { foreground: cssVar.colorTextQuaternary }
		},
		{
...
//#endregion
export { lobe_theme_default as default };
//# sourceMappingURL=lobe-theme.mjs.map